...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      'code-keyword': 'var(--code-keyword-color)',
      'code-string': 'var(--code-string-color)',
      'code-comment': 'var(--code-comment-color)',
      'code-number': 'var(--code-number-color)',
      'code-tag': 'var(--code-tag-color)',
      'code-attr': 'var(--code-attr-color)',
      'code-decorator': 'var(--code-decorator-color)',
      },
    },
  },
