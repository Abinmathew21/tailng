...
import { TNG_RESPONSIVE_MATRIX_LAYOUT_CHART_PRESET } from './responsive-matrix-layout-option.factory';
...
export class TngResponsiveMatrixLayoutChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_RESPONSIVE_MATRIX_LAYOUT_CHART_PRESET;
}
