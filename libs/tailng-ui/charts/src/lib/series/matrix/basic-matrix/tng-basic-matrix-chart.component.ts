...
import { TNG_BASIC_MATRIX_CHART_PRESET } from './basic-matrix-option.factory';
...
export class TngBasicMatrixChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_MATRIX_CHART_PRESET;
}
