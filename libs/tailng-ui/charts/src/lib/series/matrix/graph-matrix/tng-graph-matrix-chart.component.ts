...
import { TNG_GRAPH_MATRIX_CHART_PRESET } from './graph-matrix-option.factory';
...
export class TngGraphMatrixChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GRAPH_MATRIX_CHART_PRESET;
}
