...
import { TNG_PIE_MATRIX_CHART_PRESET } from './pie-matrix-option.factory';
...
export class TngPieMatrixChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_PIE_MATRIX_CHART_PRESET;
}
