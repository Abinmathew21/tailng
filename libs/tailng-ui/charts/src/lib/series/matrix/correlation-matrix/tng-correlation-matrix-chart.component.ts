...
import { TNG_CORRELATION_MATRIX_CHART_PRESET } from './correlation-matrix-option.factory';
...
export class TngCorrelationMatrixChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CORRELATION_MATRIX_CHART_PRESET;
}
