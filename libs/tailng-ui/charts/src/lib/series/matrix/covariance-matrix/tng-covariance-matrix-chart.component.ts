...
import { TNG_COVARIANCE_MATRIX_CHART_PRESET } from './covariance-matrix-option.factory';
...
export class TngCovarianceMatrixChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_COVARIANCE_MATRIX_CHART_PRESET;
}
