...
import { TNG_CONFUSION_MATRIX_CHART_PRESET } from './confusion-matrix-option.factory';
...
export class TngConfusionMatrixChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CONFUSION_MATRIX_CHART_PRESET;
}
