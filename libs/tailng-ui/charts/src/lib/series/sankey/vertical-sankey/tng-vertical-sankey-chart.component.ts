...
import { TNG_VERTICAL_SANKEY_CHART_PRESET } from './vertical-sankey-option.factory';
...
export class TngVerticalSankeyChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_VERTICAL_SANKEY_CHART_PRESET;
}
