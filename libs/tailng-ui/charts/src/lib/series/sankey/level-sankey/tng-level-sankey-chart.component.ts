...
import { TNG_LEVEL_SANKEY_CHART_PRESET } from './level-sankey-option.factory';
...
export class TngLevelSankeyChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LEVEL_SANKEY_CHART_PRESET;
}
