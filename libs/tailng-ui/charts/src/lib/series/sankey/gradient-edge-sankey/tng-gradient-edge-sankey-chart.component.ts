...
import { TNG_GRADIENT_EDGE_SANKEY_CHART_PRESET } from './gradient-edge-sankey-option.factory';
...
export class TngGradientEdgeSankeyChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GRADIENT_EDGE_SANKEY_CHART_PRESET;
}
