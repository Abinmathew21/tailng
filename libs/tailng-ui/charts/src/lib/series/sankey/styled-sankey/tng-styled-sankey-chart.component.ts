...
import { TNG_STYLED_SANKEY_CHART_PRESET } from './styled-sankey-option.factory';
...
export class TngStyledSankeyChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_STYLED_SANKEY_CHART_PRESET;
}
