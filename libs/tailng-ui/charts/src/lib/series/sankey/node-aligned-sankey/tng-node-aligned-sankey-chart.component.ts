...
import { TNG_NODE_ALIGNED_SANKEY_CHART_PRESET } from './node-aligned-sankey-option.factory';
...
export class TngNodeAlignedSankeyChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_NODE_ALIGNED_SANKEY_CHART_PRESET;
}
