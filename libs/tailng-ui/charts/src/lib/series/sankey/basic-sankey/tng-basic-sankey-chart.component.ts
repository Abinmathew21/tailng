...
import { TNG_BASIC_SANKEY_CHART_PRESET } from './basic-sankey-option.factory';
...
export class TngBasicSankeyChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_SANKEY_CHART_PRESET;
}
