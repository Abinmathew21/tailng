...
import { TNG_STYLED_CHORD_CHART_PRESET } from './styled-chord-option.factory';
...
export class TngStyledChordChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_STYLED_CHORD_CHART_PRESET;
}
