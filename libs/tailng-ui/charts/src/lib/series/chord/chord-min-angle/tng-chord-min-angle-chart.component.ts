...
import { TNG_CHORD_MIN_ANGLE_CHART_PRESET } from './chord-min-angle-option.factory';
...
export class TngChordMinAngleChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CHORD_MIN_ANGLE_CHART_PRESET;
}
