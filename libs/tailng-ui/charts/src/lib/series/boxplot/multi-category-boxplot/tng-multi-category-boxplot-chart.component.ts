...
import { TNG_MULTI_CATEGORY_BOXPLOT_CHART_PRESET } from './multi-category-boxplot-option.factory';
...
export class TngMultiCategoryBoxplotChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_MULTI_CATEGORY_BOXPLOT_CHART_PRESET;
}
