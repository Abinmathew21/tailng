...
import { TNG_BASIC_BOXPLOT_CHART_PRESET } from './basic-boxplot-option.factory';
...
export class TngBasicBoxplotChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_BOXPLOT_CHART_PRESET;
}
