...
import { TNG_AGGREGATED_BOXPLOT_CHART_PRESET } from './aggregated-boxplot-option.factory';
...
export class TngAggregatedBoxplotChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_AGGREGATED_BOXPLOT_CHART_PRESET;
}
