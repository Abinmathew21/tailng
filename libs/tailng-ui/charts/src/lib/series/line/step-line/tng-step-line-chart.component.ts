...
import { TNG_STEP_LINE_CHART_PRESET } from './step-line-option.factory';
...
export class TngStepLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_STEP_LINE_CHART_PRESET;
}
