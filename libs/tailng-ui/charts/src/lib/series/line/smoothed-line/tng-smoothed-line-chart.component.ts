...
import { TNG_SMOOTHED_LINE_CHART_PRESET } from './smoothed-line-option.factory';
...
export class TngSmoothedLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SMOOTHED_LINE_CHART_PRESET;
}
