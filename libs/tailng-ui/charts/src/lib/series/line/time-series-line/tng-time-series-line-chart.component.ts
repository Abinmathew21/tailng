...
import { TNG_TIME_SERIES_LINE_CHART_PRESET } from './time-series-line-option.factory';
...
export class TngTimeSeriesLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_TIME_SERIES_LINE_CHART_PRESET;
}
