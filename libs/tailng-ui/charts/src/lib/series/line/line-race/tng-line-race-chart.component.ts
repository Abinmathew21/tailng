...
import { TNG_LINE_RACE_CHART_PRESET } from './line-race-option.factory';
...
export class TngLineRaceChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LINE_RACE_CHART_PRESET;
}
