...
import { TNG_SPARKLINE_CHART_PRESET } from './sparkline-option.factory';
...
export class TngSparklineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SPARKLINE_CHART_PRESET;
}
