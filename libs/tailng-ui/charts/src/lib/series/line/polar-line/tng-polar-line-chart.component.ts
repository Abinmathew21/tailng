...
import { TNG_POLAR_LINE_CHART_PRESET } from './polar-line-option.factory';
...
export class TngPolarLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_POLAR_LINE_CHART_PRESET;
}
