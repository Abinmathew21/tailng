...
import { TNG_MULTI_AXIS_LINE_CHART_PRESET } from './multi-axis-line-option.factory';
...
export class TngMultiAxisLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_MULTI_AXIS_LINE_CHART_PRESET;
}
