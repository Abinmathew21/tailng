...
import { TNG_LOG_AXIS_LINE_CHART_PRESET } from './log-axis-line-option.factory';
...
export class TngLogAxisLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LOG_AXIS_LINE_CHART_PRESET;
}
