...
import { TNG_STACKED_LINE_CHART_PRESET } from './stacked-line-option.factory';
...
export class TngStackedLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_STACKED_LINE_CHART_PRESET;
}
