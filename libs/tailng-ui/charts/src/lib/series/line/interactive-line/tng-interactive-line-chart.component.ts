...
import { TNG_INTERACTIVE_LINE_CHART_PRESET } from './interactive-line-option.factory';
...
export class TngInteractiveLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_INTERACTIVE_LINE_CHART_PRESET;
}
