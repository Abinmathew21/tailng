...
import { TNG_DYNAMIC_LINE_CHART_PRESET } from './dynamic-line-option.factory';
...
export class TngDynamicLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_DYNAMIC_LINE_CHART_PRESET;
}
