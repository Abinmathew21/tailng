...
import { TNG_BASIC_LINE_CHART_PRESET } from './basic-line-option.factory';
...
export class TngBasicLineChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_LINE_CHART_PRESET;
}
