...
import { TNG_LARGE_SCALE_LINES_CHART_PRESET } from './large-scale-lines-option.factory';
...
export class TngLargeScaleLinesChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LARGE_SCALE_LINES_CHART_PRESET;
}
