...
import { TNG_LINES_GEO_LINES_CHART_PRESET } from './geo-lines-option.factory';
...
export class TngLinesGeoLinesChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LINES_GEO_LINES_CHART_PRESET;
}
