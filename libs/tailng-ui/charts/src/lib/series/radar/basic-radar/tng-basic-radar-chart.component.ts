...
import { TNG_BASIC_RADAR_CHART_PRESET } from './basic-radar-option.factory';
...
export class TngBasicRadarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_RADAR_CHART_PRESET;
}
