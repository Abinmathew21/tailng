...
import { TNG_MULTIPLE_RADAR_CHART_PRESET } from './multiple-radar-option.factory';
...
export class TngMultipleRadarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_MULTIPLE_RADAR_CHART_PRESET;
}
