...
import { TNG_CALENDAR_ICON_CHART_PRESET } from './calendar-icon-option.factory';
...
export class TngCalendarIconChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CALENDAR_ICON_CHART_PRESET;
}
