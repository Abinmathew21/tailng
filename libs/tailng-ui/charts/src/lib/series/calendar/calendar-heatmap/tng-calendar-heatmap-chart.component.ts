...
import { TNG_CALENDAR_CALENDAR_HEATMAP_CHART_PRESET } from './calendar-heatmap-option.factory';
...
export class TngCalendarCalendarHeatmapChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CALENDAR_CALENDAR_HEATMAP_CHART_PRESET;
}
