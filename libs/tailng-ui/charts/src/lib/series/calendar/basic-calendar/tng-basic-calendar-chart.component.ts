...
import { TNG_BASIC_CALENDAR_CHART_PRESET } from './basic-calendar-option.factory';
...
export class TngBasicCalendarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_CALENDAR_CHART_PRESET;
}
