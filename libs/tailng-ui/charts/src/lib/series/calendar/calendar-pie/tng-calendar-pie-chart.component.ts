...
import { TNG_CALENDAR_PIE_CHART_PRESET } from './calendar-pie-option.factory';
...
export class TngCalendarPieChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CALENDAR_PIE_CHART_PRESET;
}
