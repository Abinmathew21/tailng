...
import { TNG_ROUNDED_BAR_CHART_PRESET } from './rounded-bar-option.factory';
...
export class TngRoundedBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_ROUNDED_BAR_CHART_PRESET;
}
