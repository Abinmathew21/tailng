...
import { TNG_STACKED_BAR_CHART_PRESET } from './stacked-bar-option.factory';
...
export class TngStackedBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_STACKED_BAR_CHART_PRESET;
}
