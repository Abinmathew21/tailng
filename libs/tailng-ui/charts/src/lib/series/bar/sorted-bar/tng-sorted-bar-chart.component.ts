...
import { TNG_SORTED_BAR_CHART_PRESET } from './sorted-bar-option.factory';
...
export class TngSortedBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SORTED_BAR_CHART_PRESET;
}
