...
import { TNG_HORIZONTAL_BAR_CHART_PRESET } from './horizontal-bar-option.factory';
...
export class TngHorizontalBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_HORIZONTAL_BAR_CHART_PRESET;
}
