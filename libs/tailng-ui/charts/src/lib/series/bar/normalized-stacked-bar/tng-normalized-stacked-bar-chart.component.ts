...
import { TNG_NORMALIZED_STACKED_BAR_CHART_PRESET } from './normalized-stacked-bar-option.factory';
...
export class TngNormalizedStackedBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_NORMALIZED_STACKED_BAR_CHART_PRESET;
}
