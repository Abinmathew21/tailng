...
import { TNG_NEGATIVE_BAR_CHART_PRESET } from './negative-bar-option.factory';
...
export class TngNegativeBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_NEGATIVE_BAR_CHART_PRESET;
}
