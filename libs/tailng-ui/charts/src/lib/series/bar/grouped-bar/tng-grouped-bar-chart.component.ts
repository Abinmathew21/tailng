...
import { TNG_GROUPED_BAR_CHART_PRESET } from './grouped-bar-option.factory';
...
export class TngGroupedBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GROUPED_BAR_CHART_PRESET;
}
