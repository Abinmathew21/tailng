...
import { TNG_BAR_RACE_CHART_PRESET } from './bar-race-option.factory';
...
export class TngBarRaceChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BAR_RACE_CHART_PRESET;
}
