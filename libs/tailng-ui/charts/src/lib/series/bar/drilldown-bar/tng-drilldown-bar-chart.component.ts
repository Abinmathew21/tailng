...
import { TNG_DRILLDOWN_BAR_CHART_PRESET } from './drilldown-bar-option.factory';
...
export class TngDrilldownBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_DRILLDOWN_BAR_CHART_PRESET;
}
