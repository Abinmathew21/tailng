...
import { TNG_POLAR_BAR_CHART_PRESET } from './polar-bar-option.factory';
...
export class TngPolarBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_POLAR_BAR_CHART_PRESET;
}
