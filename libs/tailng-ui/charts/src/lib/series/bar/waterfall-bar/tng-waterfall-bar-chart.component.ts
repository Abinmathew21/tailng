...
import { TNG_WATERFALL_BAR_CHART_PRESET } from './waterfall-bar-option.factory';
...
export class TngWaterfallBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_WATERFALL_BAR_CHART_PRESET;
}
