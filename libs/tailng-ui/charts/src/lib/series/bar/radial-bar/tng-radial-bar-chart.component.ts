...
import { TNG_RADIAL_BAR_CHART_PRESET } from './radial-bar-option.factory';
...
export class TngRadialBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_RADIAL_BAR_CHART_PRESET;
}
