...
import { TNG_LARGE_SCALE_BAR_CHART_PRESET } from './large-scale-bar-option.factory';
...
export class TngLargeScaleBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LARGE_SCALE_BAR_CHART_PRESET;
}
