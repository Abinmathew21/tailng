...
import { TNG_DYNAMIC_BAR_CHART_PRESET } from './dynamic-bar-option.factory';
...
export class TngDynamicBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_DYNAMIC_BAR_CHART_PRESET;
}
