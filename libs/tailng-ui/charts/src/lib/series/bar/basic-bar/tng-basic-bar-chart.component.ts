...
import { TNG_BASIC_BAR_CHART_PRESET } from './basic-bar-option.factory';
...
export class TngBasicBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_BAR_CHART_PRESET;
}
