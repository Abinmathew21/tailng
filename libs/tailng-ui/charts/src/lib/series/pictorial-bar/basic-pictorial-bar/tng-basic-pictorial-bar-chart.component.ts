...
import { TNG_BASIC_PICTORIAL_BAR_CHART_PRESET } from './basic-pictorial-bar-option.factory';
...
export class TngBasicPictorialBarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_PICTORIAL_BAR_CHART_PRESET;
}
