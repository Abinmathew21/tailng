...
import { TNG_REGRESSION_SCATTER_CHART_PRESET } from './regression-scatter-option.factory';
...
export class TngRegressionScatterChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_REGRESSION_SCATTER_CHART_PRESET;
}
