...
import { TNG_JITTER_SCATTER_CHART_PRESET } from './jitter-scatter-option.factory';
...
export class TngJitterScatterChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_JITTER_SCATTER_CHART_PRESET;
}
