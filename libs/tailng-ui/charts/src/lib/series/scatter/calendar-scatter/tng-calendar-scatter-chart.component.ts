...
import { TNG_CALENDAR_SCATTER_CHART_PRESET } from './calendar-scatter-option.factory';
...
export class TngCalendarScatterChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CALENDAR_SCATTER_CHART_PRESET;
}
