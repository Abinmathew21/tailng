...
import { TNG_SINGLE_AXIS_SCATTER_CHART_PRESET } from './single-axis-scatter-option.factory';
...
export class TngSingleAxisScatterChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SINGLE_AXIS_SCATTER_CHART_PRESET;
}
