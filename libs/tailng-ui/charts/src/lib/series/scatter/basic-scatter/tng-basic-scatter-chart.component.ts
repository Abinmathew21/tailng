...
import { TNG_BASIC_SCATTER_CHART_PRESET } from './basic-scatter-option.factory';
...
export class TngBasicScatterChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_SCATTER_CHART_PRESET;
}
