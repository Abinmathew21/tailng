...
import { TNG_EFFECT_SCATTER_CHART_PRESET } from './effect-scatter-option.factory';
...
export class TngEffectScatterChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_EFFECT_SCATTER_CHART_PRESET;
}
