...
import { TNG_SCATTER_MATRIX_CHART_PRESET } from './scatter-matrix-option.factory';
...
export class TngScatterMatrixChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SCATTER_MATRIX_CHART_PRESET;
}
