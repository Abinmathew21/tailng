...
@Component({
  ...
  templateUrl: './tng-scatter-chart.component.html',
  styleUrl: './tng-scatter-chart.component.css',
})
export class TngScatterChartComponent {
  public readonly colorField = input<string | null>(null);
  ...
  public readonly sizeField = input<string | null>(null);
