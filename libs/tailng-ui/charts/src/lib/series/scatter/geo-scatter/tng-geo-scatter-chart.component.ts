...
import { TNG_SCATTER_GEO_SCATTER_CHART_PRESET } from './geo-scatter-option.factory';
...
export class TngScatterGeoScatterChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SCATTER_GEO_SCATTER_CHART_PRESET;
}
