...
import { TNG_DISK_USAGE_TREEMAP_CHART_PRESET } from './disk-usage-treemap-option.factory';
...
export class TngDiskUsageTreemapChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_DISK_USAGE_TREEMAP_CHART_PRESET;
}
