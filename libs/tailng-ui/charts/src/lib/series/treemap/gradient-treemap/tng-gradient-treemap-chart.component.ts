...
import { TNG_GRADIENT_TREEMAP_CHART_PRESET } from './gradient-treemap-option.factory';
...
export class TngGradientTreemapChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GRADIENT_TREEMAP_CHART_PRESET;
}
