...
import { TNG_PIE_ON_CALENDAR_CHART_PRESET } from './pie-on-calendar-option.factory';
...
export class TngPieOnCalendarChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_PIE_ON_CALENDAR_CHART_PRESET;
}
