...
import { TNG_NIGHTINGALE_CHART_PRESET } from './nightingale-option.factory';
...
export class TngNightingaleChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_NIGHTINGALE_CHART_PRESET;
}
