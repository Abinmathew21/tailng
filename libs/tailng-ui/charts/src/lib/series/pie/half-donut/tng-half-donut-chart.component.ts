...
import { TNG_HALF_DONUT_CHART_PRESET } from './half-donut-option.factory';
...
export class TngHalfDonutChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_HALF_DONUT_CHART_PRESET;
}
