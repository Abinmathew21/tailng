...
import { TNG_SCROLLABLE_LEGEND_PIE_CHART_PRESET } from './scrollable-legend-pie-option.factory';
...
export class TngScrollableLegendPieChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SCROLLABLE_LEGEND_PIE_CHART_PRESET;
}
