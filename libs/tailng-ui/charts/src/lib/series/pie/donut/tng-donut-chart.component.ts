...
import { TNG_DONUT_CHART_PRESET } from './donut-option.factory';
...
export class TngDonutChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_DONUT_CHART_PRESET;
}
