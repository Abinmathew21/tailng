...
import { TNG_ROUNDED_DONUT_CHART_PRESET } from './rounded-donut-option.factory';
...
export class TngRoundedDonutChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_ROUNDED_DONUT_CHART_PRESET;
}
