...
import { TNG_BASIC_PIE_CHART_PRESET } from './basic-pie-option.factory';
...
export class TngBasicPieChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_PIE_CHART_PRESET;
}
