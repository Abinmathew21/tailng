...
import { TNG_NESTED_PIE_CHART_PRESET } from './nested-pie-option.factory';
...
export class TngNestedPieChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_NESTED_PIE_CHART_PRESET;
}
