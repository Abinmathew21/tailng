...
import { TNG_SVG_MAP_CHART_PRESET } from './svg-map-option.factory';
...
export class TngSvgMapChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SVG_MAP_CHART_PRESET;
}
