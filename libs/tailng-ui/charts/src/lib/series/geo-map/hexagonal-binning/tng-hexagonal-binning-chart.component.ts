...
import { TNG_HEXAGONAL_BINNING_CHART_PRESET } from './hexagonal-binning-option.factory';
...
export class TngHexagonalBinningChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_HEXAGONAL_BINNING_CHART_PRESET;
}
