...
import { TNG_GEO_MAP_GEO_LINES_CHART_PRESET } from './geo-lines-option.factory';
...
export class TngGeoMapGeoLinesChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GEO_MAP_GEO_LINES_CHART_PRESET;
}
