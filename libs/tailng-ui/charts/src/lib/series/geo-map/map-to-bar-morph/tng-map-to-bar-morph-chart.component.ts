...
import { TNG_MAP_TO_BAR_MORPH_CHART_PRESET } from './map-to-bar-morph-option.factory';
...
export class TngMapToBarMorphChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_MAP_TO_BAR_MORPH_CHART_PRESET;
}
