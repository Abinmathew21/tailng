...
import { TNG_CHOROPLETH_MAP_CHART_PRESET } from './choropleth-map-option.factory';
...
export class TngChoroplethMapChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CHOROPLETH_MAP_CHART_PRESET;
}
