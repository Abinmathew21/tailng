...
import { TNG_GEO_GRAPH_CHART_PRESET } from './geo-graph-option.factory';
...
export class TngGeoGraphChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GEO_GRAPH_CHART_PRESET;
}
