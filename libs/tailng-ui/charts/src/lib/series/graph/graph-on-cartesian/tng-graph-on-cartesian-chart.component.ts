...
import { TNG_GRAPH_ON_CARTESIAN_CHART_PRESET } from './graph-on-cartesian-option.factory';
...
export class TngGraphOnCartesianChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GRAPH_ON_CARTESIAN_CHART_PRESET;
}
