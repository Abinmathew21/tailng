...
import { TNG_FORCE_GRAPH_CHART_PRESET } from './force-graph-option.factory';
...
export class TngForceGraphChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_FORCE_GRAPH_CHART_PRESET;
}
