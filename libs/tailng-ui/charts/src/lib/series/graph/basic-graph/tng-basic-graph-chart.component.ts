...
import { TNG_BASIC_GRAPH_CHART_PRESET } from './basic-graph-option.factory';
...
export class TngBasicGraphChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_GRAPH_CHART_PRESET;
}
