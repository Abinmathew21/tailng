...
import { TNG_GRAPH_CALENDAR_GRAPH_CHART_PRESET } from './calendar-graph-option.factory';
...
export class TngGraphCalendarGraphChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GRAPH_CALENDAR_GRAPH_CHART_PRESET;
}
