...
import { TNG_DYNAMIC_GRAPH_CHART_PRESET } from './dynamic-graph-option.factory';
...
export class TngDynamicGraphChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_DYNAMIC_GRAPH_CHART_PRESET;
}
