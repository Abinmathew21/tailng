...
import { TNG_CARTESIAN_HEATMAP_CHART_PRESET } from './cartesian-heatmap-option.factory';
...
export class TngCartesianHeatmapChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CARTESIAN_HEATMAP_CHART_PRESET;
}
