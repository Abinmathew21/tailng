...
import { TNG_LARGE_HEATMAP_CHART_PRESET } from './large-heatmap-option.factory';
...
export class TngLargeHeatmapChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LARGE_HEATMAP_CHART_PRESET;
}
