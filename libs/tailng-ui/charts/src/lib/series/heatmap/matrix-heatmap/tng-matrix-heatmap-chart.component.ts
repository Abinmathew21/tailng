...
import { TNG_MATRIX_HEATMAP_CHART_PRESET } from './matrix-heatmap-option.factory';
...
export class TngMatrixHeatmapChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_MATRIX_HEATMAP_CHART_PRESET;
}
