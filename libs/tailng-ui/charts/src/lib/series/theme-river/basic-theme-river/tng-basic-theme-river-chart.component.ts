...
import { TNG_BASIC_THEME_RIVER_CHART_PRESET } from './basic-theme-river-option.factory';
...
export class TngBasicThemeRiverChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_THEME_RIVER_CHART_PRESET;
}
