...
import { TNG_BASIC_PARALLEL_CHART_PRESET } from './basic-parallel-option.factory';
...
export class TngBasicParallelChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_PARALLEL_CHART_PRESET;
}
