...
import { TNG_NUTRIENTS_PARALLEL_CHART_PRESET } from './nutrients-parallel-option.factory';
...
export class TngNutrientsParallelChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_NUTRIENTS_PARALLEL_CHART_PRESET;
}
