...
import { TNG_CUSTOMIZED_FUNNEL_CHART_PRESET } from './customized-funnel-option.factory';
...
export class TngCustomizedFunnelChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CUSTOMIZED_FUNNEL_CHART_PRESET;
}
