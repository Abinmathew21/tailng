...
import { TNG_BASIC_FUNNEL_CHART_PRESET } from './basic-funnel-option.factory';
...
export class TngBasicFunnelChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_FUNNEL_CHART_PRESET;
}
