...
import { TNG_COMPARE_FUNNEL_CHART_PRESET } from './compare-funnel-option.factory';
...
export class TngCompareFunnelChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_COMPARE_FUNNEL_CHART_PRESET;
}
