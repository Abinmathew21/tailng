...
import { TNG_MULTIPLE_FUNNEL_CHART_PRESET } from './multiple-funnel-option.factory';
...
export class TngMultipleFunnelChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_MULTIPLE_FUNNEL_CHART_PRESET;
}
