...
import { TNG_POLYLINE_TREE_CHART_PRESET } from './polyline-tree-option.factory';
...
export class TngPolylineTreeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_POLYLINE_TREE_CHART_PRESET;
}
