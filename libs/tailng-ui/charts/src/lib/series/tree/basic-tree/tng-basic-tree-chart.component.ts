...
import { TNG_BASIC_TREE_CHART_PRESET } from './basic-tree-option.factory';
...
export class TngBasicTreeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_TREE_CHART_PRESET;
}
