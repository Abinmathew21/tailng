...
import { TNG_HORIZONTAL_TREE_CHART_PRESET } from './horizontal-tree-option.factory';
...
export class TngHorizontalTreeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_HORIZONTAL_TREE_CHART_PRESET;
}
