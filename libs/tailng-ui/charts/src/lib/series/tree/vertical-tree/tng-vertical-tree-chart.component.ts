...
import { TNG_VERTICAL_TREE_CHART_PRESET } from './vertical-tree-option.factory';
...
export class TngVerticalTreeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_VERTICAL_TREE_CHART_PRESET;
}
