...
import { TNG_RADIAL_TREE_CHART_PRESET } from './radial-tree-option.factory';
...
export class TngRadialTreeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_RADIAL_TREE_CHART_PRESET;
}
