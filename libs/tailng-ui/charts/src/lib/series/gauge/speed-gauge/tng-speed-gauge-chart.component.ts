...
import { TNG_SPEED_GAUGE_CHART_PRESET } from './speed-gauge-option.factory';
...
export class TngSpeedGaugeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_SPEED_GAUGE_CHART_PRESET;
}
