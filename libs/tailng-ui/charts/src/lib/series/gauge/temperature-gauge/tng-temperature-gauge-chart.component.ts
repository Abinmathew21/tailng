...
import { TNG_TEMPERATURE_GAUGE_CHART_PRESET } from './temperature-gauge-option.factory';
...
export class TngTemperatureGaugeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_TEMPERATURE_GAUGE_CHART_PRESET;
}
