...
import { TNG_GRADE_GAUGE_CHART_PRESET } from './grade-gauge-option.factory';
...
export class TngGradeGaugeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GRADE_GAUGE_CHART_PRESET;
}
