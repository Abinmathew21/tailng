...
import { TNG_MULTI_TITLE_GAUGE_CHART_PRESET } from './multi-title-gauge-option.factory';
...
export class TngMultiTitleGaugeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_MULTI_TITLE_GAUGE_CHART_PRESET;
}
