...
import { TNG_RING_GAUGE_CHART_PRESET } from './ring-gauge-option.factory';
...
export class TngRingGaugeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_RING_GAUGE_CHART_PRESET;
}
