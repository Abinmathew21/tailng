...
import { TNG_BAROMETER_GAUGE_CHART_PRESET } from './barometer-gauge-option.factory';
...
export class TngBarometerGaugeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BAROMETER_GAUGE_CHART_PRESET;
}
