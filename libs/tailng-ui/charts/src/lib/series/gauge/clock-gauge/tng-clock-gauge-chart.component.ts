...
import { TNG_CLOCK_GAUGE_CHART_PRESET } from './clock-gauge-option.factory';
...
export class TngClockGaugeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CLOCK_GAUGE_CHART_PRESET;
}
