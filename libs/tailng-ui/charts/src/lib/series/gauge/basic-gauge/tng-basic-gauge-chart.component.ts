...
import { TNG_BASIC_GAUGE_CHART_PRESET } from './basic-gauge-option.factory';
...
export class TngBasicGaugeChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_GAUGE_CHART_PRESET;
}
