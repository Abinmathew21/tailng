...
import { TNG_VISUAL_MAP_SUNBURST_CHART_PRESET } from './visual-map-sunburst-option.factory';
...
export class TngVisualMapSunburstChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_VISUAL_MAP_SUNBURST_CHART_PRESET;
}
