...
import { TNG_MONOCHROME_SUNBURST_CHART_PRESET } from './monochrome-sunburst-option.factory';
...
export class TngMonochromeSunburstChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_MONOCHROME_SUNBURST_CHART_PRESET;
}
