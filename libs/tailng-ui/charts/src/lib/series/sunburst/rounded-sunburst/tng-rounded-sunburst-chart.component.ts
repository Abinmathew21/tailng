...
import { TNG_ROUNDED_SUNBURST_CHART_PRESET } from './rounded-sunburst-option.factory';
...
export class TngRoundedSunburstChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_ROUNDED_SUNBURST_CHART_PRESET;
}
