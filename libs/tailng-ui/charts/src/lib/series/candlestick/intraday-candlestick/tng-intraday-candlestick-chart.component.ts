...
import { TNG_INTRADAY_CANDLESTICK_CHART_PRESET } from './intraday-candlestick-option.factory';
...
export class TngIntradayCandlestickChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_INTRADAY_CANDLESTICK_CHART_PRESET;
}
