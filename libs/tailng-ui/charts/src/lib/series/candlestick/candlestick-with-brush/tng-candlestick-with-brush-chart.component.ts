...
import { TNG_CANDLESTICK_WITH_BRUSH_CHART_PRESET } from './candlestick-with-brush-option.factory';
...
export class TngCandlestickWithBrushChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CANDLESTICK_WITH_BRUSH_CHART_PRESET;
}
