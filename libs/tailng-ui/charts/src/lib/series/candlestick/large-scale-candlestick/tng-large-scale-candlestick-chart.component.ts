...
import { TNG_LARGE_SCALE_CANDLESTICK_CHART_PRESET } from './large-scale-candlestick-option.factory';
...
export class TngLargeScaleCandlestickChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LARGE_SCALE_CANDLESTICK_CHART_PRESET;
}
