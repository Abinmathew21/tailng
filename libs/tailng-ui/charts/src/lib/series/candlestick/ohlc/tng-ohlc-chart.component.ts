...
import { TNG_OHLC_CHART_PRESET } from './ohlc-option.factory';
...
export class TngOhlcChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_OHLC_CHART_PRESET;
}
