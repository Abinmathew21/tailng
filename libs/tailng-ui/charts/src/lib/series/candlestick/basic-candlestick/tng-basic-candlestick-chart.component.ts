...
import { TNG_BASIC_CANDLESTICK_CHART_PRESET } from './basic-candlestick-option.factory';
...
export class TngBasicCandlestickChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_CANDLESTICK_CHART_PRESET;
}
