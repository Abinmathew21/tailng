...
import { TNG_AREA_PIECES_CHART_PRESET } from './area-pieces-option.factory';
...
export class TngAreaPiecesChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_AREA_PIECES_CHART_PRESET;
}
