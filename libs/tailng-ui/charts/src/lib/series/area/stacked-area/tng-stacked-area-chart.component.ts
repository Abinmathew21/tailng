...
import { TNG_STACKED_AREA_CHART_PRESET } from './stacked-area-option.factory';
...
export class TngStackedAreaChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_STACKED_AREA_CHART_PRESET;
}
