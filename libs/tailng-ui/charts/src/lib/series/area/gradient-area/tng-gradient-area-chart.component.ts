...
import { TNG_GRADIENT_AREA_CHART_PRESET } from './gradient-area-option.factory';
...
export class TngGradientAreaChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_GRADIENT_AREA_CHART_PRESET;
}
