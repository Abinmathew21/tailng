...
import { TNG_LARGE_SCALE_AREA_CHART_PRESET } from './large-scale-area-option.factory';
...
export class TngLargeScaleAreaChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_LARGE_SCALE_AREA_CHART_PRESET;
}
