...
import { TNG_CONFIDENCE_BAND_CHART_PRESET } from './confidence-band-option.factory';
...
export class TngConfidenceBandChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_CONFIDENCE_BAND_CHART_PRESET;
}
