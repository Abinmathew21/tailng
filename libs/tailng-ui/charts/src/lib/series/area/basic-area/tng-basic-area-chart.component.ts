...
import { TNG_BASIC_AREA_CHART_PRESET } from './basic-area-option.factory';
...
export class TngBasicAreaChartComponent extends TngCatalogChartComponentBase {
  protected override readonly preset = TNG_BASIC_AREA_CHART_PRESET;
}
