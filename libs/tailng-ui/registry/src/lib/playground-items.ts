...
export const ALL_PLAYGROUND_ITEMS: readonly TngPlaygroundItem[] = Object.freeze([
  ...
  { path: '/datepicker', title: 'Datepicker', description: 'Headless calendar selection with popup state and keyboard navigation.', category: 'form',
    headless: true,
    headlessTest: true,
    component: false,
    componentTest: false,
  ...
  { path: '/table', title: 'Table', description: 'Headless semantic table with sortable headers and controller-driven state.', category: 'layout',
    headless: true,
    headlessTest: true,
    component: false,
    componentTest: false,
