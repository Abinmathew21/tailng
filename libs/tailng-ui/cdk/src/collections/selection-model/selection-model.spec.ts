...
it('createSelectionModel: hydrates initial values', () => {
...
it('createSelectionModel: keeps only one selected value in single mode', () => {
...
it('createSelectionModel: supports multiple selected values in multiple mode', () => {
...
it('createSelectionModel: does not duplicate repeated values in multiple mode', () => {
  const model = createSelectionModel<string>({ mode: 'multiple' });
...
it('createSelectionModel: toggles selected values off', () => {
  const model = createSelectionModel<string>({ mode: 'multiple' });
...
it('createSelectionModel: toggle in single mode clears existing selection first', () => {
  const model = createSelectionModel<string>({ mode: 'single' });
...
it('createSelectionModel: deselect and clear are safe no-op operations for missing values', () => {
  const model = createSelectionModel<string>({
