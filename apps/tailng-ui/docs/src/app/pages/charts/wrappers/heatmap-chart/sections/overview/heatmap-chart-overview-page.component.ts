...
@Component({
  selector: 'app-heatmap-chart-overview-page',
  imports: [TngCodeBlockComponent, ChartWrapperLiveDemoComponent],
  templateUrl: './heatmap-chart-overview-page.component.html',
  styleUrl: './heatmap-chart-overview-page.component.css',
})
export class HeatmapChartOverviewPageComponent implements OnDestroy {
  ...
  protected readonly usageCode = [
    ...
    '  template: `<tng-heatmap-chart [data]="data" xField="hour" yField="day" valueField="value" [height]="320" />`,',
    '})',
