...
@Component({
  selector: 'app-scatter-chart-overview-page',
  imports: [TngCodeBlockComponent, ChartWrapperLiveDemoComponent],
  templateUrl: './scatter-chart-overview-page.component.html',
  styleUrl: './scatter-chart-overview-page.component.css',
})
export class ScatterChartOverviewPageComponent implements OnDestroy {
  ...
  protected readonly usageCode = [
    ...
    '  template: `<tng-scatter-chart [data]="data" xField="visits" yField="conversion" sizeField="volume" [height]="320" />`,',
    '})',
