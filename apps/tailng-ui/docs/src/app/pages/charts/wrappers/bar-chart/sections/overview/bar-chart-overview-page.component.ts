...
@Component({
  selector: 'app-bar-chart-overview-page',
  imports: [TngCodeBlockComponent, ChartWrapperLiveDemoComponent],
  templateUrl: './bar-chart-overview-page.component.html',
  styleUrl: './bar-chart-overview-page.component.css',
})
export class BarChartOverviewPageComponent implements OnDestroy {
  ...
  protected readonly usageCode = [
    '@Component({',
    '  imports: [TngBarChart],',
    '  template: `<tng-bar-chart [data]="data" xField="region" [series]="series" [height]="320" />`,',
    '})',
