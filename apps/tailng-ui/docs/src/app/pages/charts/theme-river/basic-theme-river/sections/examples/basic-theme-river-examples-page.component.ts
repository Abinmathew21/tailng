...
@Component({
  selector: 'app-basic-theme-river-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-theme-river-examples-page.component.html',
  styleUrl: './basic-theme-river-examples-page.component.css',
})
export class BasicThemeRiverExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
