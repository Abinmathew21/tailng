...
@Component({
  selector: 'app-basic-candlestick-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-candlestick-examples-page.component.html',
  styleUrl: './basic-candlestick-examples-page.component.css',
})
export class BasicCandlestickExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
