...
@Component({
  selector: 'app-ohlc-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './ohlc-examples-page.component.html',
  styleUrl: './ohlc-examples-page.component.css',
})
export class OhlcExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
