...
@Component({
  selector: 'app-intraday-candlestick-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './intraday-candlestick-examples-page.component.html',
  styleUrl: './intraday-candlestick-examples-page.component.css',
})
export class IntradayCandlestickExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
