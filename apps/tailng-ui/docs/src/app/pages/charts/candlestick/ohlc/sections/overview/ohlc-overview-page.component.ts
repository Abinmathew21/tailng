...
@Component({
  selector: 'app-ohlc-overview-page',
  imports: [
  ...
  templateUrl: './ohlc-overview-page.component.html',
  styleUrl: './ohlc-overview-page.component.css',
})
export class OhlcOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
