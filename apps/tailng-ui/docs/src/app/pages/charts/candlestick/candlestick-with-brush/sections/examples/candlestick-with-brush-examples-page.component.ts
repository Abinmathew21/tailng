...
@Component({
  selector: 'app-candlestick-with-brush-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './candlestick-with-brush-examples-page.component.html',
  styleUrl: './candlestick-with-brush-examples-page.component.css',
})
export class CandlestickWithBrushExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
