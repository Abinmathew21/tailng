...
@Component({
  selector: 'app-grade-gauge-overview-page',
  imports: [
  ...
  templateUrl: './grade-gauge-overview-page.component.html',
  styleUrl: './grade-gauge-overview-page.component.css',
})
export class GradeGaugeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
