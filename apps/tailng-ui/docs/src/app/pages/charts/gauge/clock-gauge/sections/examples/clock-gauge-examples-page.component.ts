...
@Component({
  selector: 'app-clock-gauge-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './clock-gauge-examples-page.component.html',
  styleUrl: './clock-gauge-examples-page.component.css',
})
export class ClockGaugeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
