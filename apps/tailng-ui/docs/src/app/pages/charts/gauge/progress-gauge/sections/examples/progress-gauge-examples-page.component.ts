...
@Component({
  selector: 'app-progress-gauge-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './progress-gauge-examples-page.component.html',
  styleUrl: './progress-gauge-examples-page.component.css',
})
export class ProgressGaugeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
