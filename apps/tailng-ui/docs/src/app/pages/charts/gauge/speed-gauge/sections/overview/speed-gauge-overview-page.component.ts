...
@Component({
  selector: 'app-speed-gauge-overview-page',
  imports: [
  ...
  templateUrl: './speed-gauge-overview-page.component.html',
  styleUrl: './speed-gauge-overview-page.component.css',
})
export class SpeedGaugeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
