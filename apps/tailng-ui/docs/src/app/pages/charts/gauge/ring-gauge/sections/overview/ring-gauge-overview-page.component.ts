...
@Component({
  selector: 'app-ring-gauge-overview-page',
  imports: [
  ...
  templateUrl: './ring-gauge-overview-page.component.html',
  styleUrl: './ring-gauge-overview-page.component.css',
})
export class RingGaugeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
