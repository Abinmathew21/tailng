...
@Component({
  selector: 'app-basic-gauge-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-gauge-examples-page.component.html',
  styleUrl: './basic-gauge-examples-page.component.css',
})
export class BasicGaugeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
