...
@Component({
  selector: 'app-clock-gauge-overview-page',
  imports: [
  ...
  templateUrl: './clock-gauge-overview-page.component.html',
  styleUrl: './clock-gauge-overview-page.component.css',
})
export class ClockGaugeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
