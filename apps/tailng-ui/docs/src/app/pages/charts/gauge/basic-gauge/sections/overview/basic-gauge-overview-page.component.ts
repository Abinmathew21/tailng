...
@Component({
  selector: 'app-basic-gauge-overview-page',
  imports: [
  ...
  templateUrl: './basic-gauge-overview-page.component.html',
  styleUrl: './basic-gauge-overview-page.component.css',
})
export class BasicGaugeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
