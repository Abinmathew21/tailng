...
@Component({
  selector: 'app-grade-gauge-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './grade-gauge-examples-page.component.html',
  styleUrl: './grade-gauge-examples-page.component.css',
})
export class GradeGaugeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
