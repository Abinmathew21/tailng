...
@Component({
  selector: 'app-ring-gauge-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './ring-gauge-examples-page.component.html',
  styleUrl: './ring-gauge-examples-page.component.css',
})
export class RingGaugeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
