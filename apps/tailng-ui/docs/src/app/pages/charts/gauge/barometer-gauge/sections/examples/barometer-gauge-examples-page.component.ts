...
@Component({
  selector: 'app-barometer-gauge-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './barometer-gauge-examples-page.component.html',
  styleUrl: './barometer-gauge-examples-page.component.css',
})
export class BarometerGaugeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
