...
export const CHART_SERIES_TAILWIND_SHELL_CLASS = [
...
export function createChartSeriesCodeTabs(options: {
  baseName: string;
  tsCode: string;
  htmlCode: string;
  cssCode: string;
...
export const CHART_SERIES_PLAIN_LAYOUT_CSS = [
  '/* Layout only; chart colors come from TailNG chart variables on the host. */',
  '',
  '.chart-series-example-preview {',
  '  display: grid;',
  '  gap: 0.85rem;',
  '  width: min(100%, 48rem);',
  '}',
  '',
  '.chart-series-example-chart--plain {',
  ...
  '}',
  '',
  '.chart-series-example-chart--themed tng-basic-line-chart,',
  '.chart-series-example-chart--themed tng-stacked-bar-chart,',
  '.chart-series-example-chart--themed tng-donut-chart {',
...
export const CHART_SERIES_TAILWIND_LAYOUT_CSS = [
