...
import { BASIC_LINE_CHART_CONFIG, BASIC_LINE_FIELD_INPUTS } from '../../basic-line-pilot.data';
...
export class BasicLineApiPageComponent extends ChartSeriesPilotThemeBase {
