...
@Component({
  selector: 'app-calendar-icon-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './calendar-icon-examples-page.component.html',
  styleUrl: './calendar-icon-examples-page.component.css',
})
export class CalendarIconExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
