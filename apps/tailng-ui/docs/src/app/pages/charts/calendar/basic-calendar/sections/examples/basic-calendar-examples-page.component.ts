...
@Component({
  selector: 'app-basic-calendar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-calendar-examples-page.component.html',
  styleUrl: './basic-calendar-examples-page.component.css',
})
export class BasicCalendarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
