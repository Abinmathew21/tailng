...
@Component({
  selector: 'app-calendar-heatmap-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './calendar-heatmap-examples-page.component.html',
  styleUrl: './calendar-heatmap-examples-page.component.css',
})
export class CalendarHeatmapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
