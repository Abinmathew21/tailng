...
@Component({
  selector: 'app-calendar-icon-overview-page',
  imports: [
  ...
  templateUrl: './calendar-icon-overview-page.component.html',
  styleUrl: './calendar-icon-overview-page.component.css',
})
export class CalendarIconOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
