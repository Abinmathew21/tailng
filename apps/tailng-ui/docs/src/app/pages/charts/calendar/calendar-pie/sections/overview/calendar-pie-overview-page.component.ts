...
@Component({
  selector: 'app-calendar-pie-overview-page',
  imports: [
  ...
  templateUrl: './calendar-pie-overview-page.component.html',
  styleUrl: './calendar-pie-overview-page.component.css',
})
export class CalendarPieOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
