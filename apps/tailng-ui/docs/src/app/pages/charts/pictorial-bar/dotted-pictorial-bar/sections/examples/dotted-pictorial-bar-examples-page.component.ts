...
@Component({
  selector: 'app-dotted-pictorial-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './dotted-pictorial-bar-examples-page.component.html',
  styleUrl: './dotted-pictorial-bar-examples-page.component.css',
})
export class DottedPictorialBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
