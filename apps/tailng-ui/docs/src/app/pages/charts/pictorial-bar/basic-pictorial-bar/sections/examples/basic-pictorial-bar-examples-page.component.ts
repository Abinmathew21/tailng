...
@Component({
  selector: 'app-basic-pictorial-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-pictorial-bar-examples-page.component.html',
  styleUrl: './basic-pictorial-bar-examples-page.component.css',
})
export class BasicPictorialBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
