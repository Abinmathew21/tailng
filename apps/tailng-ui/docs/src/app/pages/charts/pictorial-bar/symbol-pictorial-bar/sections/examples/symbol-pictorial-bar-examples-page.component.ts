...
@Component({
  selector: 'app-symbol-pictorial-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './symbol-pictorial-bar-examples-page.component.html',
  styleUrl: './symbol-pictorial-bar-examples-page.component.css',
})
export class SymbolPictorialBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
