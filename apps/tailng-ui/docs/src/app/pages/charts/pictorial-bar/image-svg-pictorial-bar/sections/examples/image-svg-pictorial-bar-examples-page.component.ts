...
@Component({
  selector: 'app-image-svg-pictorial-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './image-svg-pictorial-bar-examples-page.component.html',
  styleUrl: './image-svg-pictorial-bar-examples-page.component.css',
})
export class ImageSvgPictorialBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
