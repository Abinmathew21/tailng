...
@Component({
  selector: 'app-styled-chord-overview-page',
  imports: [
  ...
  templateUrl: './styled-chord-overview-page.component.html',
  styleUrl: './styled-chord-overview-page.component.css',
})
export class StyledChordOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
