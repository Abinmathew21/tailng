...
@Component({
  selector: 'app-chord-min-angle-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './chord-min-angle-examples-page.component.html',
  styleUrl: './chord-min-angle-examples-page.component.css',
})
export class ChordMinAngleExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
