...
@Component({
  selector: 'app-basic-chord-overview-page',
  imports: [
  ...
  templateUrl: './basic-chord-overview-page.component.html',
  styleUrl: './basic-chord-overview-page.component.css',
})
export class BasicChordOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
