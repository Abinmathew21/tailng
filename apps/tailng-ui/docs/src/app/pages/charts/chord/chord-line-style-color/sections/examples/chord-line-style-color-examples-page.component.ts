...
@Component({
  selector: 'app-chord-line-style-color-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './chord-line-style-color-examples-page.component.html',
  styleUrl: './chord-line-style-color-examples-page.component.css',
})
export class ChordLineStyleColorExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
