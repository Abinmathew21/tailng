...
@Component({
  selector: 'app-basic-chord-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-chord-examples-page.component.html',
  styleUrl: './basic-chord-examples-page.component.css',
})
export class BasicChordExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
