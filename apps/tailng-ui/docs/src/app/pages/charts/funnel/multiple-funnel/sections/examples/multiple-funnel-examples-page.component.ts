...
@Component({
  selector: 'app-multiple-funnel-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './multiple-funnel-examples-page.component.html',
  styleUrl: './multiple-funnel-examples-page.component.css',
})
export class MultipleFunnelExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
