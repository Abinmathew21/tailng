...
@Component({
  selector: 'app-basic-funnel-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-funnel-examples-page.component.html',
  styleUrl: './basic-funnel-examples-page.component.css',
})
export class BasicFunnelExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
