...
@Component({
  selector: 'app-basic-funnel-overview-page',
  imports: [
  ...
  templateUrl: './basic-funnel-overview-page.component.html',
  styleUrl: './basic-funnel-overview-page.component.css',
})
export class BasicFunnelOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
