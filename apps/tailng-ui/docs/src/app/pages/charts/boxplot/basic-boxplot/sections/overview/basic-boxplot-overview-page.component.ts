...
@Component({
  selector: 'app-basic-boxplot-overview-page',
  imports: [
  ...
  templateUrl: './basic-boxplot-overview-page.component.html',
  styleUrl: './basic-boxplot-overview-page.component.css',
})
export class BasicBoxplotOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
