...
@Component({
  selector: 'app-multi-category-boxplot-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './multi-category-boxplot-examples-page.component.html',
  styleUrl: './multi-category-boxplot-examples-page.component.css',
})
export class MultiCategoryBoxplotExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
