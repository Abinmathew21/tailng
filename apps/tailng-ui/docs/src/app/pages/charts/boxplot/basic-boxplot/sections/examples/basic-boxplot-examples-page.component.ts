...
@Component({
  selector: 'app-basic-boxplot-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-boxplot-examples-page.component.html',
  styleUrl: './basic-boxplot-examples-page.component.css',
})
export class BasicBoxplotExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
