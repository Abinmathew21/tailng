...
@Component({
  selector: 'app-aggregated-boxplot-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './aggregated-boxplot-examples-page.component.html',
  styleUrl: './aggregated-boxplot-examples-page.component.css',
})
export class AggregatedBoxplotExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
