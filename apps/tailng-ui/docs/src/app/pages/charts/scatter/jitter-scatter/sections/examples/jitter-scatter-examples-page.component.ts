...
@Component({
  selector: 'app-jitter-scatter-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './jitter-scatter-examples-page.component.html',
  styleUrl: './jitter-scatter-examples-page.component.css',
})
export class JitterScatterExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
