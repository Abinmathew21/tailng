...
@Component({
  selector: 'app-large-scatter-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './large-scatter-examples-page.component.html',
  styleUrl: './large-scatter-examples-page.component.css',
})
export class LargeScatterExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
