...
@Component({
  selector: 'app-basic-scatter-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-scatter-examples-page.component.html',
  styleUrl: './basic-scatter-examples-page.component.css',
})
export class BasicScatterExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
