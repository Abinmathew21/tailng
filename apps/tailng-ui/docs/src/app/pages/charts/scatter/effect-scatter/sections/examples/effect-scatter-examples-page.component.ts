...
@Component({
  selector: 'app-effect-scatter-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './effect-scatter-examples-page.component.html',
  styleUrl: './effect-scatter-examples-page.component.css',
})
export class EffectScatterExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
