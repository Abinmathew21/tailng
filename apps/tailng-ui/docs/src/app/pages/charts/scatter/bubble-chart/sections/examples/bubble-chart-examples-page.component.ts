...
@Component({
  selector: 'app-bubble-chart-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './bubble-chart-examples-page.component.html',
  styleUrl: './bubble-chart-examples-page.component.css',
})
export class BubbleChartExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
