...
@Component({
  selector: 'app-scatter-matrix-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './scatter-matrix-examples-page.component.html',
  styleUrl: './scatter-matrix-examples-page.component.css',
})
export class ScatterMatrixExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
