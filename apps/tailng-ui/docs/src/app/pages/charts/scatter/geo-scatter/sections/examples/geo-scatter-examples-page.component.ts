...
@Component({
  selector: 'app-geo-scatter-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './geo-scatter-examples-page.component.html',
  styleUrl: './geo-scatter-examples-page.component.css',
})
export class GeoScatterExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
