...
@Component({
  selector: 'app-single-axis-scatter-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './single-axis-scatter-examples-page.component.html',
  styleUrl: './single-axis-scatter-examples-page.component.css',
})
export class SingleAxisScatterExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
