...
@Component({
  selector: 'app-bubble-chart-overview-page',
  imports: [
  ...
  templateUrl: './bubble-chart-overview-page.component.html',
  styleUrl: './bubble-chart-overview-page.component.css',
})
export class BubbleChartOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
