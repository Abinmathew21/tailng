...
@Component({
  selector: 'app-large-scatter-overview-page',
  imports: [
  ...
  templateUrl: './large-scatter-overview-page.component.html',
  styleUrl: './large-scatter-overview-page.component.css',
})
export class LargeScatterOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
