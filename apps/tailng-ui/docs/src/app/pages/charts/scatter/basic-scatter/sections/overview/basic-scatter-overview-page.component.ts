...
@Component({
  selector: 'app-basic-scatter-overview-page',
  imports: [
  ...
  templateUrl: './basic-scatter-overview-page.component.html',
  styleUrl: './basic-scatter-overview-page.component.css',
})
export class BasicScatterOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
