...
@Component({
  selector: 'app-regression-scatter-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './regression-scatter-examples-page.component.html',
  styleUrl: './regression-scatter-examples-page.component.css',
})
export class RegressionScatterExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
