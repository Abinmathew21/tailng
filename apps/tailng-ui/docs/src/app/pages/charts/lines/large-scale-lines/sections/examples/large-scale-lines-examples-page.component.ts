...
@Component({
  selector: 'app-large-scale-lines-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './large-scale-lines-examples-page.component.html',
  styleUrl: './large-scale-lines-examples-page.component.css',
})
export class LargeScaleLinesExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
