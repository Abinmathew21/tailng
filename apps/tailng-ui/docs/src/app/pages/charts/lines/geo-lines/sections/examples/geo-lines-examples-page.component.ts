...
@Component({
  selector: 'app-geo-lines-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './geo-lines-examples-page.component.html',
  styleUrl: './geo-lines-examples-page.component.css',
})
export class GeoLinesExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
