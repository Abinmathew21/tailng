...
@Component({
  selector: 'app-disk-usage-treemap-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './disk-usage-treemap-examples-page.component.html',
  styleUrl: './disk-usage-treemap-examples-page.component.css',
})
export class DiskUsageTreemapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
