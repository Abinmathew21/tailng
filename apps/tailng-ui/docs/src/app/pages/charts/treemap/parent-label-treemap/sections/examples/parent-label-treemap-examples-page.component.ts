...
@Component({
  selector: 'app-parent-label-treemap-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './parent-label-treemap-examples-page.component.html',
  styleUrl: './parent-label-treemap-examples-page.component.css',
})
export class ParentLabelTreemapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
