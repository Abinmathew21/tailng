...
@Component({
  selector: 'app-basic-treemap-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-treemap-examples-page.component.html',
  styleUrl: './basic-treemap-examples-page.component.css',
})
export class BasicTreemapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
