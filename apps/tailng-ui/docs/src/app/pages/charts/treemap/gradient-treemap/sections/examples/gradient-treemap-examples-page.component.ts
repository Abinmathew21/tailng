...
@Component({
  selector: 'app-gradient-treemap-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './gradient-treemap-examples-page.component.html',
  styleUrl: './gradient-treemap-examples-page.component.css',
})
export class GradientTreemapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
