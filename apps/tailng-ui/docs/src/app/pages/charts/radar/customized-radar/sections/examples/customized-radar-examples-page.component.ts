...
@Component({
  selector: 'app-customized-radar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './customized-radar-examples-page.component.html',
  styleUrl: './customized-radar-examples-page.component.css',
})
export class CustomizedRadarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
