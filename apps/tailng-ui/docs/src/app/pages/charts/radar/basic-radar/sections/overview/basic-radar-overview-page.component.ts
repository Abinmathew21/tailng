...
@Component({
  selector: 'app-basic-radar-overview-page',
  imports: [
  ...
  templateUrl: './basic-radar-overview-page.component.html',
  styleUrl: './basic-radar-overview-page.component.css',
})
export class BasicRadarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
