...
@Component({
  selector: 'app-basic-radar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-radar-examples-page.component.html',
  styleUrl: './basic-radar-examples-page.component.css',
})
export class BasicRadarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
