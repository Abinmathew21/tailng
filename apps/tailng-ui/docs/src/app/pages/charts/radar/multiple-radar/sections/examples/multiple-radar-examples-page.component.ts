...
@Component({
  selector: 'app-multiple-radar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './multiple-radar-examples-page.component.html',
  styleUrl: './multiple-radar-examples-page.component.css',
})
export class MultipleRadarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
