...
@Component({
  selector: 'app-monochrome-sunburst-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './monochrome-sunburst-examples-page.component.html',
  styleUrl: './monochrome-sunburst-examples-page.component.css',
})
export class MonochromeSunburstExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
