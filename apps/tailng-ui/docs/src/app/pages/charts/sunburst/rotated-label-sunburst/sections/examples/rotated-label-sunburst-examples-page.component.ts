...
@Component({
  selector: 'app-rotated-label-sunburst-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './rotated-label-sunburst-examples-page.component.html',
  styleUrl: './rotated-label-sunburst-examples-page.component.css',
})
export class RotatedLabelSunburstExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
