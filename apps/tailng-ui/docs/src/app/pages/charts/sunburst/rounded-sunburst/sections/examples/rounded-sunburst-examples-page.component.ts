...
@Component({
  selector: 'app-rounded-sunburst-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './rounded-sunburst-examples-page.component.html',
  styleUrl: './rounded-sunburst-examples-page.component.css',
})
export class RoundedSunburstExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
