...
@Component({
  selector: 'app-basic-sunburst-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-sunburst-examples-page.component.html',
  styleUrl: './basic-sunburst-examples-page.component.css',
})
export class BasicSunburstExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
