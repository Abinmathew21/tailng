...
@Component({
  selector: 'app-line-race-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './line-race-examples-page.component.html',
  styleUrl: './line-race-examples-page.component.css',
})
export class LineRaceExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
