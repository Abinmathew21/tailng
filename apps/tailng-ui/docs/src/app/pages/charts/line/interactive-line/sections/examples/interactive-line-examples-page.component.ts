...
@Component({
  selector: 'app-interactive-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './interactive-line-examples-page.component.html',
  styleUrl: './interactive-line-examples-page.component.css',
})
export class InteractiveLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
