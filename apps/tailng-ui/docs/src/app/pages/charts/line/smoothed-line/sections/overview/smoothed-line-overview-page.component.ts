...
@Component({
  selector: 'app-smoothed-line-overview-page',
  imports: [
  ...
  templateUrl: './smoothed-line-overview-page.component.html',
  styleUrl: './smoothed-line-overview-page.component.css',
})
export class SmoothedLineOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
