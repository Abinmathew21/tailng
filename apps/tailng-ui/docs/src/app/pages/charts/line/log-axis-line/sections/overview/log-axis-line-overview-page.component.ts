...
@Component({
  selector: 'app-log-axis-line-overview-page',
  imports: [
  ...
  templateUrl: './log-axis-line-overview-page.component.html',
  styleUrl: './log-axis-line-overview-page.component.css',
})
export class LogAxisLineOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
