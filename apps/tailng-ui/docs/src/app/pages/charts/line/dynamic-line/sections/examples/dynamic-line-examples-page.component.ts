...
@Component({
  selector: 'app-dynamic-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './dynamic-line-examples-page.component.html',
  styleUrl: './dynamic-line-examples-page.component.css',
})
export class DynamicLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
