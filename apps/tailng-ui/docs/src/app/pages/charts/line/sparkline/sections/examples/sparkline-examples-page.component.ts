...
@Component({
  selector: 'app-sparkline-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './sparkline-examples-page.component.html',
  styleUrl: './sparkline-examples-page.component.css',
})
export class SparklineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
