...
@Component({
  selector: 'app-line-race-overview-page',
  imports: [
  ...
  templateUrl: './line-race-overview-page.component.html',
  styleUrl: './line-race-overview-page.component.css',
})
export class LineRaceOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
