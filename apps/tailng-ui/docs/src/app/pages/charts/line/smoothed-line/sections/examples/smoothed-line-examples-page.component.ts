...
@Component({
  selector: 'app-smoothed-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './smoothed-line-examples-page.component.html',
  styleUrl: './smoothed-line-examples-page.component.css',
})
export class SmoothedLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
