...
@Component({
  selector: 'app-step-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './step-line-examples-page.component.html',
  styleUrl: './step-line-examples-page.component.css',
})
export class StepLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
