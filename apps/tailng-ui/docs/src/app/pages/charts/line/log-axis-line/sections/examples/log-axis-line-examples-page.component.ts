...
@Component({
  selector: 'app-log-axis-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './log-axis-line-examples-page.component.html',
  styleUrl: './log-axis-line-examples-page.component.css',
})
export class LogAxisLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
