...
@Component({
  selector: 'app-polar-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './polar-line-examples-page.component.html',
  styleUrl: './polar-line-examples-page.component.css',
})
export class PolarLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
