...
@Component({
  selector: 'app-stacked-line-overview-page',
  imports: [
  ...
  templateUrl: './stacked-line-overview-page.component.html',
  styleUrl: './stacked-line-overview-page.component.css',
})
export class StackedLineOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
