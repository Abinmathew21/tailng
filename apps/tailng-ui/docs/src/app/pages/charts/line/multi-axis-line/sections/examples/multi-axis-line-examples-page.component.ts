...
@Component({
  selector: 'app-multi-axis-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './multi-axis-line-examples-page.component.html',
  styleUrl: './multi-axis-line-examples-page.component.css',
})
export class MultiAxisLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
