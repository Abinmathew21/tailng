...
@Component({
  selector: 'app-sparkline-overview-page',
  imports: [
  ...
  templateUrl: './sparkline-overview-page.component.html',
  styleUrl: './sparkline-overview-page.component.css',
})
export class SparklineOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
