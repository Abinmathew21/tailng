...
@Component({
  selector: 'app-line-with-mark-lines-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './line-with-mark-lines-examples-page.component.html',
  styleUrl: './line-with-mark-lines-examples-page.component.css',
})
export class LineWithMarkLinesExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
