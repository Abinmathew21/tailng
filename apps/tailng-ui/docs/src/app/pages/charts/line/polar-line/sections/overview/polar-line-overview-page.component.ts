...
@Component({
  selector: 'app-polar-line-overview-page',
  imports: [
  ...
  templateUrl: './polar-line-overview-page.component.html',
  styleUrl: './polar-line-overview-page.component.css',
})
export class PolarLineOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
