...
@Component({
  selector: 'app-dynamic-line-overview-page',
  imports: [
  ...
  templateUrl: './dynamic-line-overview-page.component.html',
  styleUrl: './dynamic-line-overview-page.component.css',
})
export class DynamicLineOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
