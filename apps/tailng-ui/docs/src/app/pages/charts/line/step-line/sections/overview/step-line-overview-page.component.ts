...
@Component({
  selector: 'app-step-line-overview-page',
  imports: [
  ...
  templateUrl: './step-line-overview-page.component.html',
  styleUrl: './step-line-overview-page.component.css',
})
export class StepLineOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
