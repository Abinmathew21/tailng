...
@Component({
  selector: 'app-stacked-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './stacked-line-examples-page.component.html',
  styleUrl: './stacked-line-examples-page.component.css',
})
export class StackedLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
