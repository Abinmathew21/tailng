...
@Component({
  selector: 'app-large-scale-line-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './large-scale-line-examples-page.component.html',
  styleUrl: './large-scale-line-examples-page.component.css',
})
export class LargeScaleLineExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
