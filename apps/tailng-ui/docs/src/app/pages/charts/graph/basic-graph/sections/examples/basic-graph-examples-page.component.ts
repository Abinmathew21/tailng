...
@Component({
  selector: 'app-basic-graph-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-graph-examples-page.component.html',
  styleUrl: './basic-graph-examples-page.component.css',
})
export class BasicGraphExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
