...
@Component({
  selector: 'app-geo-graph-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './geo-graph-examples-page.component.html',
  styleUrl: './geo-graph-examples-page.component.css',
})
export class GeoGraphExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
