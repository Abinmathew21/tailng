...
@Component({
  selector: 'app-basic-graph-overview-page',
  imports: [
  ...
  templateUrl: './basic-graph-overview-page.component.html',
  styleUrl: './basic-graph-overview-page.component.css',
})
export class BasicGraphOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
