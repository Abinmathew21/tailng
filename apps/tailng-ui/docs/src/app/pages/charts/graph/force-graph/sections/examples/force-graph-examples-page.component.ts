...
@Component({
  selector: 'app-force-graph-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './force-graph-examples-page.component.html',
  styleUrl: './force-graph-examples-page.component.css',
})
export class ForceGraphExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
