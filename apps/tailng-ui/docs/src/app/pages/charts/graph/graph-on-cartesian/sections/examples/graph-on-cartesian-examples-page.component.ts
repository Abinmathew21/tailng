...
@Component({
  selector: 'app-graph-on-cartesian-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './graph-on-cartesian-examples-page.component.html',
  styleUrl: './graph-on-cartesian-examples-page.component.css',
})
export class GraphOnCartesianExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
