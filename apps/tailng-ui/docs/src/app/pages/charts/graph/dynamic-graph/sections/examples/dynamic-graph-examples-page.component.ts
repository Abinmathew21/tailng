...
@Component({
  selector: 'app-dynamic-graph-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './dynamic-graph-examples-page.component.html',
  styleUrl: './dynamic-graph-examples-page.component.css',
})
export class DynamicGraphExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
