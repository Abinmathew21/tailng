...
@Component({
  selector: 'app-force-graph-overview-page',
  imports: [
  ...
  templateUrl: './force-graph-overview-page.component.html',
  styleUrl: './force-graph-overview-page.component.css',
})
export class ForceGraphOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
