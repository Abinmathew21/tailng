...
@Component({
  selector: 'app-geo-graph-overview-page',
  imports: [
  ...
  templateUrl: './geo-graph-overview-page.component.html',
  styleUrl: './geo-graph-overview-page.component.css',
})
export class GeoGraphOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
