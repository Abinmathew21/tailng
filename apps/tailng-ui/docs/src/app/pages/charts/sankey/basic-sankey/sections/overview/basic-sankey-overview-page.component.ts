...
@Component({
  selector: 'app-basic-sankey-overview-page',
  imports: [
  ...
  templateUrl: './basic-sankey-overview-page.component.html',
  styleUrl: './basic-sankey-overview-page.component.css',
})
export class BasicSankeyOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
