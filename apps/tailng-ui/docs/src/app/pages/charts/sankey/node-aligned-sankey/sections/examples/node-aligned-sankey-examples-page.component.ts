...
@Component({
  selector: 'app-node-aligned-sankey-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './node-aligned-sankey-examples-page.component.html',
  styleUrl: './node-aligned-sankey-examples-page.component.css',
})
export class NodeAlignedSankeyExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
