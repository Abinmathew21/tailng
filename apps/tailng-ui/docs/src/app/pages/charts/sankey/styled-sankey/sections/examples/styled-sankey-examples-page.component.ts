...
@Component({
  selector: 'app-styled-sankey-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './styled-sankey-examples-page.component.html',
  styleUrl: './styled-sankey-examples-page.component.css',
})
export class StyledSankeyExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
