...
@Component({
  selector: 'app-vertical-sankey-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './vertical-sankey-examples-page.component.html',
  styleUrl: './vertical-sankey-examples-page.component.css',
})
export class VerticalSankeyExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
