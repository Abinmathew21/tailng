...
@Component({
  selector: 'app-level-sankey-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './level-sankey-examples-page.component.html',
  styleUrl: './level-sankey-examples-page.component.css',
})
export class LevelSankeyExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
