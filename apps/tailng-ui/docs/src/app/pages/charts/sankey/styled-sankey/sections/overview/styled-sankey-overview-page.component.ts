...
@Component({
  selector: 'app-styled-sankey-overview-page',
  imports: [
  ...
  templateUrl: './styled-sankey-overview-page.component.html',
  styleUrl: './styled-sankey-overview-page.component.css',
})
export class StyledSankeyOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
