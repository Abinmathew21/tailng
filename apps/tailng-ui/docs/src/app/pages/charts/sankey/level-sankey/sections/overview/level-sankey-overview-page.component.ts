...
@Component({
  selector: 'app-level-sankey-overview-page',
  imports: [
  ...
  templateUrl: './level-sankey-overview-page.component.html',
  styleUrl: './level-sankey-overview-page.component.css',
})
export class LevelSankeyOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
