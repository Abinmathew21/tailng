...
@Component({
  selector: 'app-gradient-edge-sankey-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './gradient-edge-sankey-examples-page.component.html',
  styleUrl: './gradient-edge-sankey-examples-page.component.css',
})
export class GradientEdgeSankeyExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
