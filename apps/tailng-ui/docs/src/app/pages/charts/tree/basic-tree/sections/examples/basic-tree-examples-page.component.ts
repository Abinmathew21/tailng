...
@Component({
  selector: 'app-basic-tree-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-tree-examples-page.component.html',
  styleUrl: './basic-tree-examples-page.component.css',
})
export class BasicTreeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
