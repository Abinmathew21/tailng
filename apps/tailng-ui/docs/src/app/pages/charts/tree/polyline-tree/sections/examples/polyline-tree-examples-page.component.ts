...
@Component({
  selector: 'app-polyline-tree-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './polyline-tree-examples-page.component.html',
  styleUrl: './polyline-tree-examples-page.component.css',
})
export class PolylineTreeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
