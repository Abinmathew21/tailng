...
@Component({
  selector: 'app-polyline-tree-overview-page',
  imports: [
  ...
  templateUrl: './polyline-tree-overview-page.component.html',
  styleUrl: './polyline-tree-overview-page.component.css',
})
export class PolylineTreeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
