...
@Component({
  selector: 'app-vertical-tree-overview-page',
  imports: [
  ...
  templateUrl: './vertical-tree-overview-page.component.html',
  styleUrl: './vertical-tree-overview-page.component.css',
})
export class VerticalTreeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
