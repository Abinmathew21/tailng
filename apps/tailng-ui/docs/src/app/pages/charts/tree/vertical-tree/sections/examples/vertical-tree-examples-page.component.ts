...
@Component({
  selector: 'app-vertical-tree-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './vertical-tree-examples-page.component.html',
  styleUrl: './vertical-tree-examples-page.component.css',
})
export class VerticalTreeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
