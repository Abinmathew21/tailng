...
@Component({
  selector: 'app-horizontal-tree-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './horizontal-tree-examples-page.component.html',
  styleUrl: './horizontal-tree-examples-page.component.css',
})
export class HorizontalTreeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
