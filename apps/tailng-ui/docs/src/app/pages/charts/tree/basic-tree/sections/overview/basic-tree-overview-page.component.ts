...
@Component({
  selector: 'app-basic-tree-overview-page',
  imports: [
  ...
  templateUrl: './basic-tree-overview-page.component.html',
  styleUrl: './basic-tree-overview-page.component.css',
})
export class BasicTreeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
