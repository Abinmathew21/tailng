...
@Component({
  selector: 'app-radial-tree-overview-page',
  imports: [
  ...
  templateUrl: './radial-tree-overview-page.component.html',
  styleUrl: './radial-tree-overview-page.component.css',
})
export class RadialTreeOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
