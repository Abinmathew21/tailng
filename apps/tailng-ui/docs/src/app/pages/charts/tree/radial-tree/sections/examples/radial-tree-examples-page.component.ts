...
@Component({
  selector: 'app-radial-tree-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './radial-tree-examples-page.component.html',
  styleUrl: './radial-tree-examples-page.component.css',
})
export class RadialTreeExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
