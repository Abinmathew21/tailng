...
@Component({
  selector: 'app-pie-on-calendar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './pie-on-calendar-examples-page.component.html',
  styleUrl: './pie-on-calendar-examples-page.component.css',
})
export class PieOnCalendarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
