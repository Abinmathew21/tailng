...
@Component({
  selector: 'app-nested-pie-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './nested-pie-examples-page.component.html',
  styleUrl: './nested-pie-examples-page.component.css',
})
export class NestedPieExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
