...
@Component({
  selector: 'app-scrollable-legend-pie-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './scrollable-legend-pie-examples-page.component.html',
  styleUrl: './scrollable-legend-pie-examples-page.component.css',
})
export class ScrollableLegendPieExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
