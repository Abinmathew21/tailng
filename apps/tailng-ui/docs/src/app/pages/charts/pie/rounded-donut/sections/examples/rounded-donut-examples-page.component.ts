...
@Component({
  selector: 'app-rounded-donut-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './rounded-donut-examples-page.component.html',
  styleUrl: './rounded-donut-examples-page.component.css',
})
export class RoundedDonutExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
