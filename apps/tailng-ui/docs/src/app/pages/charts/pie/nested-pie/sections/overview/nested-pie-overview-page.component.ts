...
@Component({
  selector: 'app-nested-pie-overview-page',
  imports: [
  ...
  templateUrl: './nested-pie-overview-page.component.html',
  styleUrl: './nested-pie-overview-page.component.css',
})
export class NestedPieOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
