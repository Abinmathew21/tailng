...
@Component({
  selector: 'app-basic-pie-overview-page',
  imports: [
  ...
  templateUrl: './basic-pie-overview-page.component.html',
  styleUrl: './basic-pie-overview-page.component.css',
})
export class BasicPieOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
