...
@Component({
  selector: 'app-half-donut-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './half-donut-examples-page.component.html',
  styleUrl: './half-donut-examples-page.component.css',
})
export class HalfDonutExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
