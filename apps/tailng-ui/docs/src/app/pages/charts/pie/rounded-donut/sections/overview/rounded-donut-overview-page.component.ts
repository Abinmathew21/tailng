...
@Component({
  selector: 'app-rounded-donut-overview-page',
  imports: [
  ...
  templateUrl: './rounded-donut-overview-page.component.html',
  styleUrl: './rounded-donut-overview-page.component.css',
})
export class RoundedDonutOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
