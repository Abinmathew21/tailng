...
@Component({
  selector: 'app-nightingale-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './nightingale-examples-page.component.html',
  styleUrl: './nightingale-examples-page.component.css',
})
export class NightingaleExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
