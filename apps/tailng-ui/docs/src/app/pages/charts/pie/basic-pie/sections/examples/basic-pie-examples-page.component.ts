...
@Component({
  selector: 'app-basic-pie-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-pie-examples-page.component.html',
  styleUrl: './basic-pie-examples-page.component.css',
})
export class BasicPieExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
