...
@Component({
  selector: 'app-pie-on-geo-map-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './pie-on-geo-map-examples-page.component.html',
  styleUrl: './pie-on-geo-map-examples-page.component.css',
})
export class PieOnGeoMapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
