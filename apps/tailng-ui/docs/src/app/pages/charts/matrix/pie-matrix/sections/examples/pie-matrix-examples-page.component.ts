...
@Component({
  selector: 'app-pie-matrix-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './pie-matrix-examples-page.component.html',
  styleUrl: './pie-matrix-examples-page.component.css',
})
export class PieMatrixExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
