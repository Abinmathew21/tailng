...
@Component({
  selector: 'app-graph-matrix-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './graph-matrix-examples-page.component.html',
  styleUrl: './graph-matrix-examples-page.component.css',
})
export class GraphMatrixExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
