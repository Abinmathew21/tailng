...
@Component({
  selector: 'app-covariance-matrix-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './covariance-matrix-examples-page.component.html',
  styleUrl: './covariance-matrix-examples-page.component.css',
})
export class CovarianceMatrixExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
