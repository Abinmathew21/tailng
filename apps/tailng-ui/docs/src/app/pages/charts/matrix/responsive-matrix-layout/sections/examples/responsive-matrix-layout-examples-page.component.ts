...
@Component({
  selector: 'app-responsive-matrix-layout-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './responsive-matrix-layout-examples-page.component.html',
  styleUrl: './responsive-matrix-layout-examples-page.component.css',
})
export class ResponsiveMatrixLayoutExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
