...
@Component({
  selector: 'app-confusion-matrix-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './confusion-matrix-examples-page.component.html',
  styleUrl: './confusion-matrix-examples-page.component.css',
})
export class ConfusionMatrixExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
