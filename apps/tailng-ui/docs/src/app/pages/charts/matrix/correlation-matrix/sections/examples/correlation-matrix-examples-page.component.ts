...
@Component({
  selector: 'app-correlation-matrix-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './correlation-matrix-examples-page.component.html',
  styleUrl: './correlation-matrix-examples-page.component.css',
})
export class CorrelationMatrixExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
