...
@Component({
  selector: 'app-basic-matrix-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-matrix-examples-page.component.html',
  styleUrl: './basic-matrix-examples-page.component.css',
})
export class BasicMatrixExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
