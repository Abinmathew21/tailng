...
@Component({
  selector: 'app-basic-matrix-overview-page',
  imports: [
  ...
  templateUrl: './basic-matrix-overview-page.component.html',
  styleUrl: './basic-matrix-overview-page.component.css',
})
export class BasicMatrixOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
