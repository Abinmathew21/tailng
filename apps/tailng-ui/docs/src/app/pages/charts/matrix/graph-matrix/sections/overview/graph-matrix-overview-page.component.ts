...
@Component({
  selector: 'app-graph-matrix-overview-page',
  imports: [
  ...
  templateUrl: './graph-matrix-overview-page.component.html',
  styleUrl: './graph-matrix-overview-page.component.css',
})
export class GraphMatrixOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
