...
@Component({
  selector: 'app-pie-matrix-overview-page',
  imports: [
  ...
  templateUrl: './pie-matrix-overview-page.component.html',
  styleUrl: './pie-matrix-overview-page.component.css',
})
export class PieMatrixOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
