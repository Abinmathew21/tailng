...
@Component({
  selector: 'app-basic-parallel-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-parallel-examples-page.component.html',
  styleUrl: './basic-parallel-examples-page.component.css',
})
export class BasicParallelExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
