...
@Component({
  selector: 'app-nutrients-parallel-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './nutrients-parallel-examples-page.component.html',
  styleUrl: './nutrients-parallel-examples-page.component.css',
})
export class NutrientsParallelExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
