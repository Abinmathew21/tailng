...
@Component({
  selector: 'app-aqi-parallel-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './aqi-parallel-examples-page.component.html',
  styleUrl: './aqi-parallel-examples-page.component.css',
})
export class AqiParallelExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
