...
@Component({
  selector: 'app-aqi-parallel-overview-page',
  imports: [
  ...
  templateUrl: './aqi-parallel-overview-page.component.html',
  styleUrl: './aqi-parallel-overview-page.component.css',
})
export class AqiParallelOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
