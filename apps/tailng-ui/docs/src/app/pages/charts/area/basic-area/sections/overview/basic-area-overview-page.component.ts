...
@Component({
  selector: 'app-basic-area-overview-page',
  imports: [
  ...
  templateUrl: './basic-area-overview-page.component.html',
  styleUrl: './basic-area-overview-page.component.css',
})
export class BasicAreaOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
