...
@Component({
  selector: 'app-large-scale-area-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './large-scale-area-examples-page.component.html',
  styleUrl: './large-scale-area-examples-page.component.css',
})
export class LargeScaleAreaExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
