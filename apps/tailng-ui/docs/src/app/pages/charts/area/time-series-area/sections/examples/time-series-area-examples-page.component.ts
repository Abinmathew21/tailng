...
@Component({
  selector: 'app-time-series-area-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './time-series-area-examples-page.component.html',
  styleUrl: './time-series-area-examples-page.component.css',
})
export class TimeSeriesAreaExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
