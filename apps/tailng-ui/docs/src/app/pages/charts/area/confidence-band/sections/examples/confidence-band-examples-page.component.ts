...
@Component({
  selector: 'app-confidence-band-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './confidence-band-examples-page.component.html',
  styleUrl: './confidence-band-examples-page.component.css',
})
export class ConfidenceBandExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
