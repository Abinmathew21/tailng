...
@Component({
  selector: 'app-basic-area-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-area-examples-page.component.html',
  styleUrl: './basic-area-examples-page.component.css',
})
export class BasicAreaExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
