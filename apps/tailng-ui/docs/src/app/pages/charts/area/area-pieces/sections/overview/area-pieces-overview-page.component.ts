...
@Component({
  selector: 'app-area-pieces-overview-page',
  imports: [
  ...
  templateUrl: './area-pieces-overview-page.component.html',
  styleUrl: './area-pieces-overview-page.component.css',
})
export class AreaPiecesOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
