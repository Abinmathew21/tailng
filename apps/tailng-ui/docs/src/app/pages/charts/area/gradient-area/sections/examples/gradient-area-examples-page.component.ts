...
@Component({
  selector: 'app-gradient-area-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './gradient-area-examples-page.component.html',
  styleUrl: './gradient-area-examples-page.component.css',
})
export class GradientAreaExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
