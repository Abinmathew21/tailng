...
@Component({
  selector: 'app-stacked-area-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './stacked-area-examples-page.component.html',
  styleUrl: './stacked-area-examples-page.component.css',
})
export class StackedAreaExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
