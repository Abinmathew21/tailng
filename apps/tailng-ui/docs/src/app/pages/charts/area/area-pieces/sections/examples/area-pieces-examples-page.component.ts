...
@Component({
  selector: 'app-area-pieces-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './area-pieces-examples-page.component.html',
  styleUrl: './area-pieces-examples-page.component.css',
})
export class AreaPiecesExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
