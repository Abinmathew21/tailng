...
@Component({
  selector: 'app-gradient-area-overview-page',
  imports: [
  ...
  templateUrl: './gradient-area-overview-page.component.html',
  styleUrl: './gradient-area-overview-page.component.css',
})
export class GradientAreaOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
