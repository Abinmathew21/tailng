...
@Component({
  selector: 'app-stacked-area-overview-page',
  imports: [
  ...
  templateUrl: './stacked-area-overview-page.component.html',
  styleUrl: './stacked-area-overview-page.component.css',
})
export class StackedAreaOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
