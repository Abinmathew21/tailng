...
@Component({
  selector: 'app-hexagonal-binning-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './hexagonal-binning-examples-page.component.html',
  styleUrl: './hexagonal-binning-examples-page.component.css',
})
export class HexagonalBinningExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
