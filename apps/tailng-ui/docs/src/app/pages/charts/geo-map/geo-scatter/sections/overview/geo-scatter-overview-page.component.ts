...
@Component({
  selector: 'app-geo-scatter-overview-page',
  imports: [
  ...
  templateUrl: './geo-scatter-overview-page.component.html',
  styleUrl: './geo-scatter-overview-page.component.css',
})
export class GeoScatterOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
