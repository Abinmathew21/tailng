...
@Component({
  selector: 'app-map-to-bar-morph-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './map-to-bar-morph-examples-page.component.html',
  styleUrl: './map-to-bar-morph-examples-page.component.css',
})
export class MapToBarMorphExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
