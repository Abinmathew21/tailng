...
@Component({
  selector: 'app-choropleth-map-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './choropleth-map-examples-page.component.html',
  styleUrl: './choropleth-map-examples-page.component.css',
})
export class ChoroplethMapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
