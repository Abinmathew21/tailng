...
@Component({
  selector: 'app-svg-map-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './svg-map-examples-page.component.html',
  styleUrl: './svg-map-examples-page.component.css',
})
export class SvgMapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
