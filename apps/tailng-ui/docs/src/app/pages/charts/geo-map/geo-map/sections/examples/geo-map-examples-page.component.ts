...
@Component({
  selector: 'app-geo-map-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './geo-map-examples-page.component.html',
  styleUrl: './geo-map-examples-page.component.css',
})
export class GeoMapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
