...
@Component({
  selector: 'app-svg-map-overview-page',
  imports: [
  ...
  templateUrl: './svg-map-overview-page.component.html',
  styleUrl: './svg-map-overview-page.component.css',
})
export class SvgMapOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
