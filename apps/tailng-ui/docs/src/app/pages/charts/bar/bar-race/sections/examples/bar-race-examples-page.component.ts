...
@Component({
  selector: 'app-bar-race-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './bar-race-examples-page.component.html',
  styleUrl: './bar-race-examples-page.component.css',
})
export class BarRaceExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
