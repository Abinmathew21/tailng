...
@Component({
  selector: 'app-rounded-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './rounded-bar-examples-page.component.html',
  styleUrl: './rounded-bar-examples-page.component.css',
})
export class RoundedBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
