...
@Component({
  selector: 'app-negative-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './negative-bar-examples-page.component.html',
  styleUrl: './negative-bar-examples-page.component.css',
})
export class NegativeBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
