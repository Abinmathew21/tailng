...
@Component({
  selector: 'app-basic-bar-overview-page',
  imports: [
  ...
  templateUrl: './basic-bar-overview-page.component.html',
  styleUrl: './basic-bar-overview-page.component.css',
})
export class BasicBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
