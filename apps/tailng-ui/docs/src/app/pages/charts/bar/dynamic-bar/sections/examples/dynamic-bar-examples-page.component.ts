...
@Component({
  selector: 'app-dynamic-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './dynamic-bar-examples-page.component.html',
  styleUrl: './dynamic-bar-examples-page.component.css',
})
export class DynamicBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
