...
@Component({
  selector: 'app-bar-race-overview-page',
  imports: [
  ...
  templateUrl: './bar-race-overview-page.component.html',
  styleUrl: './bar-race-overview-page.component.css',
})
export class BarRaceOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
