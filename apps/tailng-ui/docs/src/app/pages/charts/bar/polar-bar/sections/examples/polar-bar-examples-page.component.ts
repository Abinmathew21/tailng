...
@Component({
  selector: 'app-polar-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './polar-bar-examples-page.component.html',
  styleUrl: './polar-bar-examples-page.component.css',
})
export class PolarBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
