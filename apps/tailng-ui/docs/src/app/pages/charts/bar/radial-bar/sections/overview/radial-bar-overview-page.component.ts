...
@Component({
  selector: 'app-radial-bar-overview-page',
  imports: [
  ...
  templateUrl: './radial-bar-overview-page.component.html',
  styleUrl: './radial-bar-overview-page.component.css',
})
export class RadialBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
