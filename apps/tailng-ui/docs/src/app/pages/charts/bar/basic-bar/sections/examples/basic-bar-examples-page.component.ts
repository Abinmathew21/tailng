...
@Component({
  selector: 'app-basic-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './basic-bar-examples-page.component.html',
  styleUrl: './basic-bar-examples-page.component.css',
})
export class BasicBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
