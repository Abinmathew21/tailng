...
@Component({
  selector: 'app-grouped-bar-overview-page',
  imports: [
  ...
  templateUrl: './grouped-bar-overview-page.component.html',
  styleUrl: './grouped-bar-overview-page.component.css',
})
export class GroupedBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
