...
@Component({
  selector: 'app-polar-bar-overview-page',
  imports: [
  ...
  templateUrl: './polar-bar-overview-page.component.html',
  styleUrl: './polar-bar-overview-page.component.css',
})
export class PolarBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
