...
@Component({
  selector: 'app-waterfall-bar-overview-page',
  imports: [
  ...
  templateUrl: './waterfall-bar-overview-page.component.html',
  styleUrl: './waterfall-bar-overview-page.component.css',
})
export class WaterfallBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
