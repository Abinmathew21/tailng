...
@Component({
  selector: 'app-drilldown-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './drilldown-bar-examples-page.component.html',
  styleUrl: './drilldown-bar-examples-page.component.css',
})
export class DrilldownBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
