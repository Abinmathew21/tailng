...
@Component({
  selector: 'app-rounded-bar-overview-page',
  imports: [
  ...
  templateUrl: './rounded-bar-overview-page.component.html',
  styleUrl: './rounded-bar-overview-page.component.css',
})
export class RoundedBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
