...
@Component({
  selector: 'app-drilldown-bar-overview-page',
  imports: [
  ...
  templateUrl: './drilldown-bar-overview-page.component.html',
  styleUrl: './drilldown-bar-overview-page.component.css',
})
export class DrilldownBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
