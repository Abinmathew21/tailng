...
@Component({
  selector: 'app-sorted-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './sorted-bar-examples-page.component.html',
  styleUrl: './sorted-bar-examples-page.component.css',
})
export class SortedBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
