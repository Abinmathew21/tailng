...
@Component({
  selector: 'app-dynamic-bar-overview-page',
  imports: [
  ...
  templateUrl: './dynamic-bar-overview-page.component.html',
  styleUrl: './dynamic-bar-overview-page.component.css',
})
export class DynamicBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
