...
@Component({
  selector: 'app-sorted-bar-overview-page',
  imports: [
  ...
  templateUrl: './sorted-bar-overview-page.component.html',
  styleUrl: './sorted-bar-overview-page.component.css',
})
export class SortedBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
