...
@Component({
  selector: 'app-large-scale-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './large-scale-bar-examples-page.component.html',
  styleUrl: './large-scale-bar-examples-page.component.css',
})
export class LargeScaleBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
