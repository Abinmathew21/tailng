...
@Component({
  selector: 'app-normalized-stacked-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './normalized-stacked-bar-examples-page.component.html',
  styleUrl: './normalized-stacked-bar-examples-page.component.css',
})
export class NormalizedStackedBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
