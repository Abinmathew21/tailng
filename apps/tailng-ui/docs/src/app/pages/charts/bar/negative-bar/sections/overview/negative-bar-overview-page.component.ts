...
@Component({
  selector: 'app-negative-bar-overview-page',
  imports: [
  ...
  templateUrl: './negative-bar-overview-page.component.html',
  styleUrl: './negative-bar-overview-page.component.css',
})
export class NegativeBarOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
