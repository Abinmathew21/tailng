...
@Component({
  selector: 'app-grouped-bar-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './grouped-bar-examples-page.component.html',
  styleUrl: './grouped-bar-examples-page.component.css',
})
export class GroupedBarExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
