...
@Component({
  selector: 'app-cartesian-heatmap-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './cartesian-heatmap-examples-page.component.html',
  styleUrl: './cartesian-heatmap-examples-page.component.css',
})
export class CartesianHeatmapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
