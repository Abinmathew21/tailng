...
@Component({
  selector: 'app-large-heatmap-overview-page',
  imports: [
  ...
  templateUrl: './large-heatmap-overview-page.component.html',
  styleUrl: './large-heatmap-overview-page.component.css',
})
export class LargeHeatmapOverviewPageComponent extends ChartSeriesCatalogOverviewPageComponent {}
