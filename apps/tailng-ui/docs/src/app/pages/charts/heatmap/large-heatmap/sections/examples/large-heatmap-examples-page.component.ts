...
@Component({
  selector: 'app-large-heatmap-examples-page',
  imports: [
    DocsExampleTabsSectionComponent,
    DocsExampleVariantDirective,
  ...
  templateUrl: './large-heatmap-examples-page.component.html',
  styleUrl: './large-heatmap-examples-page.component.css',
})
export class LargeHeatmapExamplesPageComponent extends ChartSeriesCatalogExamplesPageComponent {}
