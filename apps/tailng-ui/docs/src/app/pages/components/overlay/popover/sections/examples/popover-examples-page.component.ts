...
export class PopoverExamplesPageComponent implements OnDestroy {
  ...
  protected readonly plainCodeTabs: readonly DocsExampleCodeTab[] = Object.freeze([
    ...
    },
    {
      ...
      code: [
        ...
        '    <button type="button" tngPopoverClose (click)="result.set(\'Canceled\')">Cancel</button>',
        '    <button type="button" tngPopoverClose [tngPopoverClose]="\'programmatic\'" (click)="result.set(\'Published\')">',
        '      Publish',
        '    </button>',
        '  </div>',
        '</tng-popover>',
  ...
  protected readonly tailwindCodeTabs: readonly DocsExampleCodeTab[] = Object.freeze([
    ...
    },
    {
      ...
      code: [
        '<tng-popover triggerLabel="Approve deployment" [open]="open()" (openChange)="open.set($event)">',
        '  <p class="m-0 text-sm text-slate-700 dark:text-slate-300">',
        '    Rollout starts in us-east then eu-west.',
        '  </p>',
        '  <div class="mt-3 flex flex-wrap justify-end gap-2">',
        '    <button type="button" tngPopoverClose class="rounded-lg border px-3 py-2 text-sm">',
        '      Hold',
        '    </button>',
        '    <button type="button" tngPopoverClose [tngPopoverClose]="\'programmatic\'" class="rounded-lg bg-emerald-600 px-3 py-2 text-sm text-white">',
        '      Approve',
        '    </button>',
        '  </div>',
        '</tng-popover>',
