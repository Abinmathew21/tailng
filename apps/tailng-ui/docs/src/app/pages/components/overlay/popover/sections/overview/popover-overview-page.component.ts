...
export class PopoverOverviewPageComponent implements OnDestroy {
  ...
  protected readonly plainCssCodeTabs: readonly DocsExampleCodeTab[] = Object.freeze([
    ...
    },
    {
      ...
      code: [
        ...
        '  <button type="button" tngPopoverClose [tngPopoverClose]="\'programmatic\'">Apply</button>',
        '</tng-popover>',
      ].join('\n'),
    },
    {
  ...
  protected readonly tailwindCodeTabs: readonly DocsExampleCodeTab[] = Object.freeze([
    ...
    },
    {
      ...
      code: [
        '<tng-popover triggerLabel="Tailwind actions" [open]="open()" (openChange)="open.set($event)">',
        '  <p class="text-sm text-slate-700 dark:text-slate-300">Projected content styled with utilities.</p>',
        '  <button tngPopoverClose [tngPopoverClose]="\'programmatic\'" class="rounded-lg bg-sky-600 px-3 py-2 text-sm text-white">',
        '    Apply',
        '  </button>',
        '</tng-popover>',
      ].join('\n'),
