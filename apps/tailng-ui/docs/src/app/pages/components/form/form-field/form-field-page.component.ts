...
const formFieldDocSectionIds: readonly FormFieldDocSectionId[] = [
  'overview',
  'api',
  'styling',
  'examples',
...
const defaultFormFieldDocSection: FormFieldDocSectionId = 'overview';

function isFormFieldDocSectionId(value: string): value is FormFieldDocSectionId {
  return formFieldDocSectionIds.includes(value as FormFieldDocSectionId);
}
...
export class FormFieldPageComponent {
  ...
  public readonly activeSection = computed<FormFieldDocSectionId>(() => {
    const section = this.resolveSectionFromUrl(this.currentUrl());
    return section ?? defaultFormFieldDocSection;
  });
