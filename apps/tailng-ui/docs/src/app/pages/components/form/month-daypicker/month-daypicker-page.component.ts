...
type MonthDaypickerDocSectionId = 'api' | 'examples' | 'overview' | 'styling';

const monthDaypickerDocSectionIds: readonly MonthDaypickerDocSectionId[] = [
  'overview',
  'api',
  'styling',
  'examples',
...
const defaultMonthDaypickerDocSection: MonthDaypickerDocSectionId = 'overview';

function isMonthDaypickerDocSectionId(value: string): value is MonthDaypickerDocSectionId {
  return monthDaypickerDocSectionIds.includes(value as MonthDaypickerDocSectionId);
}

@Component({
  selector: 'app-month-daypicker-page',
  imports: [RouterOutlet, DocsComponentSectionTabsComponent, DocsComponentSectionOutlineComponent],
  templateUrl: './month-daypicker-page.component.html',
})
export class MonthDaypickerPageComponent {
  ...
  public readonly activeSection = computed<MonthDaypickerDocSectionId>(() => {
    const section = this.resolveSectionFromUrl(this.currentUrl());
    return section ?? defaultMonthDaypickerDocSection;
  });
  ...
  private resolveSectionFromUrl(rawUrl: string): MonthDaypickerDocSectionId | null {
    ...
    if (section === undefined || !isMonthDaypickerDocSectionId(section)) {
      return null;
    }
