...
type InputFieldDocSectionId = 'api' | 'examples' | 'overview' | 'styling';

const inputFieldDocSectionIds: readonly InputFieldDocSectionId[] = [
  'overview',
  'api',
  'styling',
  'examples',
...
const defaultInputFieldDocSection: InputFieldDocSectionId = 'overview';

function isInputFieldDocSectionId(value: string): value is InputFieldDocSectionId {
  return inputFieldDocSectionIds.includes(value as InputFieldDocSectionId);
}
...
export class InputFieldPageComponent {
  ...
  public readonly activeSection = computed<InputFieldDocSectionId>(() => {
    const section = this.resolveSectionFromUrl(this.currentUrl());
    return section ?? defaultInputFieldDocSection;
  });
  ...
  private resolveSectionFromUrl(rawUrl: string): InputFieldDocSectionId | null {
    ...
    if (section === undefined || !isInputFieldDocSectionId(section)) {
      return null;
    }
