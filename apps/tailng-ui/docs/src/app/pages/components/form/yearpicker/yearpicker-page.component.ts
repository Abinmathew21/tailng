...
type YearpickerDocSectionId = 'api' | 'examples' | 'overview' | 'styling';

const yearpickerDocSectionIds: readonly YearpickerDocSectionId[] = [
  'overview',
  'api',
  'styling',
  'examples',
...
const defaultYearpickerDocSection: YearpickerDocSectionId = 'overview';

function isYearpickerDocSectionId(value: string): value is YearpickerDocSectionId {
  return yearpickerDocSectionIds.includes(value as YearpickerDocSectionId);
}

@Component({
  selector: 'app-yearpicker-page',
  imports: [RouterOutlet, DocsComponentSectionTabsComponent, DocsComponentSectionOutlineComponent],
  templateUrl: './yearpicker-page.component.html',
})
export class YearpickerPageComponent {
  ...
  public readonly activeSection = computed<YearpickerDocSectionId>(() => {
    const section = this.resolveSectionFromUrl(this.currentUrl());
    return section ?? defaultYearpickerDocSection;
  });
  ...
  private resolveSectionFromUrl(rawUrl: string): YearpickerDocSectionId | null {
    ...
    if (section === undefined || !isYearpickerDocSectionId(section)) {
      return null;
    }
