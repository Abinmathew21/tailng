...
type FileUploadDocSectionId = 'api' | 'examples' | 'overview' | 'styling';

const fileUploadDocSectionIds: readonly FileUploadDocSectionId[] = [
  'overview',
  'api',
  'styling',
  'examples',
...
const defaultFileUploadDocSection: FileUploadDocSectionId = 'overview';

function isFileUploadDocSectionId(value: string): value is FileUploadDocSectionId {
  return fileUploadDocSectionIds.includes(value as FileUploadDocSectionId);
}
...
export class FileUploadPageComponent {
  ...
  public readonly activeSection = computed<FileUploadDocSectionId>(() => {
    const section = this.resolveSectionFromUrl(this.currentUrl());
    return section ?? defaultFileUploadDocSection;
  });
  ...
  private resolveSectionFromUrl(rawUrl: string): FileUploadDocSectionId | null {
    ...
    if (section === undefined || !isFileUploadDocSectionId(section)) {
      return null;
    }
