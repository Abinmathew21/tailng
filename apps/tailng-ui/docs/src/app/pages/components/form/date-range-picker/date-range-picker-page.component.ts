...
type DateRangePickerDocSectionId = 'api' | 'examples' | 'overview' | 'styling';

const dateRangePickerDocSectionIds: readonly DateRangePickerDocSectionId[] = [
  'overview',
  'api',
  'styling',
  'examples',
...
const defaultDateRangePickerDocSection: DateRangePickerDocSectionId = 'overview';

function isDateRangePickerDocSectionId(value: string): value is DateRangePickerDocSectionId {
  return dateRangePickerDocSectionIds.includes(value as DateRangePickerDocSectionId);
}
...
export class DateRangePickerPageComponent {
  ...
  public readonly activeSection = computed<DateRangePickerDocSectionId>(() => {
    const section = this.resolveSectionFromUrl(this.currentUrl());
    return section ?? defaultDateRangePickerDocSection;
  });
  ...
  private resolveSectionFromUrl(rawUrl: string): DateRangePickerDocSectionId | null {
    ...
    if (section === undefined || !isDateRangePickerDocSectionId(section)) {
      return null;
    }
