  ...
  protected readonly tailwindCodeTabs: readonly DocsExampleCodeTab[] = Object.freeze([
    {
      ...
      code: [
        ...
        '  <tng-checkbox [checked]="true" class="text-slate-900">Email notifications</tng-checkbox>',
        '  <tng-checkbox [indeterminate]="true" class="text-slate-900">Weekly digest (mixed)</tng-checkbox>',
        '  <tng-checkbox [readonly]="true" [checked]="true" class="text-slate-900">Readonly legal acknowledgement</tng-checkbox>',
        '</div>',
        '',
      ].join('\n'),
    },
