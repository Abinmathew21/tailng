...
export class InputExamplesPageComponent implements OnDestroy {
  ...
  protected readonly typeTailwindCodeTabs = createCodeTabs(
    ...
    [
      ...
      "  <tng-input class=\"block [&_[data-slot='input-group']]:min-h-11 [&_[data-slot='input-group']]:rounded-xl [&_[data-slot='input-group']]:border [&_[data-slot='input-group']]:border-slate-300 [&_[data-slot='input-group']]:bg-white [&_[data-slot='input-group']]:px-3 [&_[data-slot='input-group']]:shadow-sm [&_[data-slot='input-group'][data-focused]]:border-blue-500 [&_[data-slot='input-group'][data-focused]]:ring-2 [&_[data-slot='input-group'][data-focused]]:ring-blue-200/70 [&_[data-slot='input']]:w-full [&_[data-slot='input']]:border-0 [&_[data-slot='input']]:bg-transparent [&_[data-slot='input']]:p-0 [&_[data-slot='input']]:text-[0.98rem] [&_[data-slot='input']]:outline-none\" type=\"email\" placeholder=\"team@tailng.dev\" ariaLabel=\"Email\"></tng-input>",
      "  <tng-input class=\"block [&_[data-slot='input-group']]:min-h-11 [&_[data-slot='input-group']]:rounded-xl [&_[data-slot='input-group']]:border [&_[data-slot='input-group']]:border-slate-300 [&_[data-slot='input-group']]:bg-white [&_[data-slot='input-group']]:px-3 [&_[data-slot='input-group']]:shadow-sm [&_[data-slot='input-group'][data-focused]]:border-blue-500 [&_[data-slot='input-group'][data-focused]]:ring-2 [&_[data-slot='input-group'][data-focused]]:ring-blue-200/70 [&_[data-slot='input']]:w-full [&_[data-slot='input']]:border-0 [&_[data-slot='input']]:bg-transparent [&_[data-slot='input']]:p-0 [&_[data-slot='input']]:text-[0.98rem] [&_[data-slot='input']]:outline-none\" type=\"search\" placeholder=\"Search docs\" ariaLabel=\"Search\"></tng-input>",
      "  <tng-input class=\"block [&_[data-slot='input-group']]:min-h-11 [&_[data-slot='input-group']]:rounded-xl [&_[data-slot='input-group']]:border [&_[data-slot='input-group']]:border-slate-300 [&_[data-slot='input-group']]:bg-white [&_[data-slot='input-group']]:px-3 [&_[data-slot='input-group']]:shadow-sm [&_[data-slot='input-group'][data-focused]]:border-blue-500 [&_[data-slot='input-group'][data-focused]]:ring-2 [&_[data-slot='input-group'][data-focused]]:ring-blue-200/70 [&_[data-slot='input']]:w-full [&_[data-slot='input']]:border-0 [&_[data-slot='input']]:bg-transparent [&_[data-slot='input']]:p-0 [&_[data-slot='input']]:text-[0.98rem] [&_[data-slot='input']]:outline-none\" type=\"number\" placeholder=\"42\" ariaLabel=\"Number\"></tng-input>",
      '</div>',
      '',
    ].join('\n'),
    this.tailwindCssCode,
  ...
  protected readonly validationTailwindCodeTabs = createCodeTabs(
    ...
    [
      ...
      "  <tng-input class=\"block [&_[data-slot='input-group']]:min-h-11 [&_[data-slot='input-group']]:rounded-xl [&_[data-slot='input-group']]:border [&_[data-slot='input-group']]:border-red-400 [&_[data-slot='input-group']]:bg-red-50/70 [&_[data-slot='input-group']]:px-3 [&_[data-slot='input-group']]:shadow-sm [&_[data-slot='input-group'][data-focused]]:border-red-500 [&_[data-slot='input-group'][data-focused]]:ring-2 [&_[data-slot='input-group'][data-focused]]:ring-red-200 [&_[data-slot='input']]:w-full [&_[data-slot='input']]:border-0 [&_[data-slot='input']]:bg-transparent [&_[data-slot='input']]:p-0 [&_[data-slot='input']]:text-[0.98rem] [&_[data-slot='input']]:outline-none\" tone=\"danger\" type=\"email\" value=\"team@tailng\" [ariaInvalid]=\"true\"></tng-input>",
  ...
  protected readonly statesTailwindCodeTabs = createCodeTabs(
    ...
    [
      '<div class="grid gap-3">',
      "  <tng-input class=\"block [&_[data-slot='input-group']]:min-h-11 [&_[data-slot='input-group']]:rounded-xl [&_[data-slot='input-group']]:border [&_[data-slot='input-group']]:border-slate-300 [&_[data-slot='input-group']]:bg-slate-100/80 [&_[data-slot='input-group']]:px-3 [&_[data-slot='input-group']]:shadow-sm [&_[data-slot='input']]:w-full [&_[data-slot='input']]:border-0 [&_[data-slot='input']]:bg-transparent [&_[data-slot='input']]:p-0 [&_[data-slot='input']]:text-[0.98rem] [&_[data-slot='input']]:outline-none\" type=\"text\" value=\"Readonly API key\" readonly></tng-input>",
      "  <tng-input class=\"block [&_[data-slot='input-group']]:min-h-11 [&_[data-slot='input-group']]:rounded-xl [&_[data-slot='input-group']]:border [&_[data-slot='input-group']]:border-slate-300 [&_[data-slot='input-group']]:bg-slate-100/80 [&_[data-slot='input-group']]:px-3 [&_[data-slot='input-group']]:opacity-60 [&_[data-slot='input']]:w-full [&_[data-slot='input']]:border-0 [&_[data-slot='input']]:bg-transparent [&_[data-slot='input']]:p-0 [&_[data-slot='input']]:text-[0.98rem] [&_[data-slot='input']]:outline-none\" type=\"text\" value=\"Disabled while syncing\" disabled></tng-input>",
      '</div>',
      '',
    ].join('\n'),
    this.tailwindCssCode,
