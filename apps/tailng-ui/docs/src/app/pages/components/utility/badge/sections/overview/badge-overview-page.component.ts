...
export class BadgeOverviewPageComponent implements OnDestroy {
  ...
  protected readonly plainCssCodeTabs = createCodeTabs(
    ...
    [
      ...
      '',
      '@Component({',
      "  selector: 'app-badge-overview-plain-css',",
      '  standalone: true,',
      '  imports: [TngBadge],',
      "  templateUrl: './badge-overview-plain-css.component.html',",
      "  styleUrl: './badge-overview-plain-css.component.css',",
      '})',
    ...
    [
      ...
      '    <button type="button" class="badge-host" [tngBadge]="count()" tngBadgeTone="info">Inbox</button>',
      '    <button type="button" class="badge-host" [tngBadge]="count() * 8" [tngBadgeMax]="99" tngBadgeTone="warning">Alerts</button>',
      '    <button type="button" class="badge-host" [tngBadge]="null" [tngBadgeDot]="dot()" tngBadgeTone="success">Presence</button>',
      '  </div>',
  ...
  protected readonly tailwindCodeTabs = createCodeTabs(
    ...
    [
      ...
      '',
      '@Component({',
      "  selector: 'app-badge-overview-tailwind',",
      '  standalone: true,',
      '  imports: [TngBadge],',
      "  templateUrl: './badge-overview-tailwind.component.html',",
      "  styleUrl: './badge-overview-tailwind.component.css',",
      '})',
    ...
    [
      ...
      '    <button type="button" [tngBadge]="count()" tngBadgeTone="danger" class="inline-flex min-h-10 min-w-28 items-center rounded-lg border border-tng-border-subtle bg-tng-bg-base px-4 py-2 text-sm font-semibold text-tng-fg-primary shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--tng-semantic-border-subtle)_55%,transparent)] transition hover:bg-tng-bg-muted">Inbox</button>',
      ...
      '    <button type="button" [tngBadge]="null" [tngBadgeDot]="dot()" tngBadgeTone="success" class="inline-flex min-h-10 min-w-28 items-center rounded-lg border border-tng-border-subtle bg-tng-bg-base px-4 py-2 text-sm font-semibold text-tng-fg-primary shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--tng-semantic-border-subtle)_55%,transparent)] transition hover:bg-tng-bg-muted">Presence</button>',
      '  </div>',
