...
type ContextMenuDocSectionId = 'api' | 'examples' | 'overview' | 'ownable-install' | 'styling';
...
@Component({
  ...
  styleUrls: ['./context-menu-page.component.css'],
})
export class ContextMenuPageComponent {
  ...
  public onSectionChange(value: string | number | null): void {
    if (typeof value !== 'string' || !isContextMenuDocSectionId(value)) {
      return;
    }
