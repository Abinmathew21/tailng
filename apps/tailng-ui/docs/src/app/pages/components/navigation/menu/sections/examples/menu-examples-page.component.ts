  ...
  protected readonly tailwindCodeTabs: readonly DocsExampleCodeTab[] = Object.freeze([
    ...
    },
    {
      ...
      code: [
        ...
        '  </div>',
        '</div>',
        '<p class="menu-example-state">last command: {{ menuExamplesTailwindLastCommand() }}</p>',
      ].join('\n'),
    },
    {
      value: 'css',
  ...
  protected readonly cascadeTailwindCodeTabs: readonly DocsExampleCodeTab[] = Object.freeze([
    ...
    },
    {
      ...
      code: [
        ...
        '  </div>',
        '</div>',
        '<p class="menu-example-state">last cascaded command: {{ menuExamplesCascadeTailwindLastCommand() }}</p>',
      ].join('\n'),
    },
    {
      value: 'css',
