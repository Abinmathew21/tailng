...
type TabsDocSectionId = 'api' | 'examples' | 'overview' | 'styling';

const tabsDocSectionIds: readonly TabsDocSectionId[] = [
  'overview',
  'api',
  'styling',
  'examples',
...
const defaultTabsDocSection: TabsDocSectionId = 'overview';

function isTabsDocSectionId(value: string): value is TabsDocSectionId {
  return tabsDocSectionIds.includes(value as TabsDocSectionId);
}
...
export class TabsPageComponent {
  ...
  public readonly activeSection = computed<TabsDocSectionId>(() => {
    const section = this.resolveSectionFromUrl(this.currentUrl());
    return section ?? defaultTabsDocSection;
  });
  ...
  public onSectionChange(value: string | number | null): void {
    if (typeof value !== 'string' || !isTabsDocSectionId(value)) {
      return;
    }
  ...
  private resolveSectionFromUrl(rawUrl: string): TabsDocSectionId | null {
    ...
    if (section === undefined || !isTabsDocSectionId(section)) {
      return null;
    }
