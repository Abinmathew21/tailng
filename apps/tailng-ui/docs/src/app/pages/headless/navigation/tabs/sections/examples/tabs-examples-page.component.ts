...
import { TngTabs, TngTab, TngTabList, TngTabPanel, type TngTabsValue } from '@tailng-ui/primitives';
...
@Component({
  selector: 'app-headless-tabs-examples-page',
  imports: [TngTabs, TngTabList, TngTab, TngTabPanel, DocsExampleTabsSectionComponent, DocsExampleVariantDirective],
  templateUrl: './tabs-examples-page.component.html',
  styleUrl: './tabs-examples-page.component.css',
})
export class HeadlessTabsExamplesPageComponent implements OnDestroy {
  ...
  protected readonly controlledPlainCodeTabs = createCodeTabs(
    'headless-tabs-controlled-plain-css',
    [
      ...
      '',
      '@Component({',
      "  selector: 'app-headless-tabs-controlled-plain-css',",
      '  standalone: true,',
      '  imports: [TngTabs, TngTabList, TngTab, TngTabPanel],',
      "  templateUrl: './headless-tabs-controlled-plain-css.component.html',",
      "  styleUrl: './headless-tabs-controlled-plain-css.component.css',",
      '})',
      'export class HeadlessTabsControlledPlainCssComponent {',
    ...
    [
      '<section tngTabs aria-label="Workspace sections" [value]="current()" (valueChange)="onValueChange($event)">',
  ...
  protected readonly controlledTailwindCodeTabs = createCodeTabs(
    'headless-tabs-controlled-tailwind',
    [
      "import { Component, signal } from '@angular/core';",
      "import { TngTabs, TngTab, TngTabList, TngTabPanel, type TngTabsValue } from '@tailng-ui/primitives';",
      '',
      ...
      '',
      '@Component({',
      "  selector: 'app-headless-tabs-controlled-tailwind',",
      '  standalone: true,',
      '  imports: [TngTabs, TngTabList, TngTab, TngTabPanel],',
      "  templateUrl: './headless-tabs-controlled-tailwind.component.html',",
      "  styleUrl: './headless-tabs-controlled-tailwind.component.css',",
      '})',
      'export class HeadlessTabsControlledTailwindComponent {',
      "  protected readonly current = signal<WorkspaceTab>('overview');",
      '',
      '  protected onValueChange(value: TngTabsValue | null): void {',
      '    if (isWorkspaceTab(value)) {',
    ...
    [
      ...
      '  <section tngTabs aria-label="Workspace sections" [value]="current()" (valueChange)="onValueChange($event)" class="grid gap-3">',
  ...
  protected readonly verticalPlainCodeTabs = createCodeTabs(
    'headless-tabs-vertical-plain-css',
    [
      "import { Component } from '@angular/core';",
      "import { TngTabs, TngTab, TngTabList, TngTabPanel } from '@tailng-ui/primitives';",
      '',
      '@Component({',
      "  selector: 'app-headless-tabs-vertical-plain-css',",
      '  standalone: true,',
      '  imports: [TngTabs, TngTabList, TngTab, TngTabPanel],',
      "  templateUrl: './headless-tabs-vertical-plain-css.component.html',",
      "  styleUrl: './headless-tabs-vertical-plain-css.component.css',",
      '})',
      'export class HeadlessTabsVerticalPlainCssComponent {}',
    ].join('\n'),
    [
      '<section tngTabs aria-label="Settings categories" orientation="vertical" activation="manual" defaultValue="account">',
  ...
  protected readonly verticalTailwindCodeTabs = createCodeTabs(
    'headless-tabs-vertical-tailwind',
    [
      "import { Component } from '@angular/core';",
      "import { TngTabs, TngTab, TngTabList, TngTabPanel } from '@tailng-ui/primitives';",
      '',
      '@Component({',
      "  selector: 'app-headless-tabs-vertical-tailwind',",
      '  standalone: true,',
      '  imports: [TngTabs, TngTabList, TngTab, TngTabPanel],',
      "  templateUrl: './headless-tabs-vertical-tailwind.component.html',",
      "  styleUrl: './headless-tabs-vertical-tailwind.component.css',",
      '})',
      'export class HeadlessTabsVerticalTailwindComponent {}',
    ].join('\n'),
    [
      '<div class="flex flex-col gap-3 rounded-2xl border border-tng-border-subtle bg-tng-bg-surface p-4 text-tng-fg-primary shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--tng-semantic-border-subtle)_55%,transparent)]">',
      '  <section tngTabs aria-label="Settings categories" orientation="vertical" activation="manual" defaultValue="account" class="grid gap-4 md:grid-cols-[13rem_minmax(0,1fr)]">',
