...
@Component({
  selector: 'app-headless-tabs-overview-page',
  imports: [
    TngTabs,
    TngTabList,
    TngTab,
...
export class HeadlessTabsOverviewPageComponent implements OnDestroy {
  ...
  protected readonly plainCssCodeTabs = createCodeTabs(
    'headless-tabs-overview-plain-css',
    [
      "import { Component } from '@angular/core';",
      "import { TngTabs, TngTab, TngTabList, TngTabPanel } from '@tailng-ui/primitives';",
      '',
      '@Component({',
      "  selector: 'app-headless-tabs-overview-plain-css',",
      '  standalone: true,',
      '  imports: [TngTabs, TngTabList, TngTab, TngTabPanel],',
      "  templateUrl: './headless-tabs-overview-plain-css.component.html',",
      "  styleUrl: './headless-tabs-overview-plain-css.component.css',",
      '})',
      'export class HeadlessTabsOverviewPlainCssComponent {}',
    ].join('\n'),
    [
      '<section tngTabs aria-label="Workspace sections" defaultValue="overview">',
  ...
  protected readonly tailwindCodeTabs = createCodeTabs(
    'headless-tabs-overview-tailwind',
    [
      "import { Component } from '@angular/core';",
      "import { TngTabs, TngTab, TngTabList, TngTabPanel } from '@tailng-ui/primitives';",
      '',
      '@Component({',
      "  selector: 'app-headless-tabs-overview-tailwind',",
      '  standalone: true,',
      '  imports: [TngTabs, TngTabList, TngTab, TngTabPanel],',
      "  templateUrl: './headless-tabs-overview-tailwind.component.html',",
      "  styleUrl: './headless-tabs-overview-tailwind.component.css',",
      '})',
      'export class HeadlessTabsOverviewTailwindComponent {}',
    ].join('\n'),
    [
      ...
      '  <section tngTabs aria-label="Workspace sections" defaultValue="overview" class="grid gap-3">',
