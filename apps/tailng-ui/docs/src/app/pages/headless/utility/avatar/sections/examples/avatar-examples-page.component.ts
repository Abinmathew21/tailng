  ...
  protected readonly rosterTailwindTabs: readonly DocsExampleCodeTab[] = Object.freeze([
    ...
    },
    {
      ...
      code: [
        ...
        '  <span tngAvatar class="relative inline-flex h-12 w-12 overflow-hidden rounded-full border border-[var(--tng-semantic-border-subtle)] bg-[var(--tng-semantic-background-base)] shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--tng-semantic-border-subtle)_55%,transparent)]"><img tngAvatarImage [attr.src]="sampleImage" alt="" class="h-full w-full object-cover" /><span tngAvatarFallback [attr.hidden]="\'\'" class="absolute inset-0 inline-flex items-center justify-center text-sm font-semibold text-[var(--tng-semantic-foreground-primary)]" aria-hidden="true">AL</span></span>',
        '  <span tngAvatar class="relative inline-flex h-10 w-10 overflow-hidden rounded-full border border-[var(--tng-semantic-border-subtle)] bg-[var(--tng-semantic-background-base)] shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--tng-semantic-border-subtle)_55%,transparent)]"><img tngAvatarImage [attr.hidden]="\'\'" alt="" class="h-full w-full object-cover" /><span tngAvatarFallback class="absolute inset-0 inline-flex items-center justify-center text-xs font-semibold text-[var(--tng-semantic-foreground-primary)]" aria-hidden="true">TN</span></span>',
        '  <span tngAvatar class="relative inline-flex h-10 w-10 overflow-hidden rounded-xl border border-[var(--tng-semantic-border-subtle)] bg-[var(--tng-semantic-background-base)] shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--tng-semantic-border-subtle)_55%,transparent)]"><img tngAvatarImage [attr.src]="sampleImage" alt="" class="h-full w-full object-cover" /><span tngAvatarFallback [attr.hidden]="\'\'" class="absolute inset-0 inline-flex items-center justify-center text-xs font-semibold text-[var(--tng-semantic-foreground-primary)]" aria-hidden="true">SQ</span></span>',
        '</div>',
        '',
      ].join('\n'),
    },
